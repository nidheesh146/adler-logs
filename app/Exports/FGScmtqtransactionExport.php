...
class FGScmtqtransactionExport implements FromCollection, WithHeadings, WithStyles,WithEvents
{
    private $items;
    ...
    public function collection()
    {
        ...
        foreach($this->items as $item)
        {
            ...
            $data[] = array(
                '#' => $i++,
                'doc_no' => $item->cmtq_number,
                    'doc_date' => date('d-m-Y', strtotime($item->cmtq_date)),
                    ...
                    'Month' => date('F', strtotime($item->cmtq_date)),
                    'Qtr' => $qtr,
                    'CY(Calender Year)' => date('Y', strtotime($item->cmtq_date)),
