...
class FGSpitransactionExport implements FromCollection, WithHeadings, WithStyles, WithEvents
{
    private $items;
    ...
    public function collection()
    {
        ...
        foreach ($this->items as $item) {
            ...
            if (date('m', strtotime($item->pi_date)) == 6 || date('m', strtotime($item->pi_date)) == 5 || date('m', strtotime($item->oef_date)) == 4) {
                $qtr = "Q1";
            }
            if (date('m', strtotime($item->pi_date)) == 7 || date('m', strtotime($item->pi_date)) == 8 || date('m', strtotime($item->oef_date)) == 9) {
                $qtr = "Q2";
            }
            if (date('m', strtotime($item->pi_date)) == 10 || date('m', strtotime($item->pi_date)) == 11 || date('m', strtotime($item->oef_date)) == 12) {
                $qtr = "Q3";
            }
            if (date('m', strtotime($item->pi_date)) == 1 || date('m', strtotime($item->pi_date)) == 2 || date('m', strtotime($item->oef_date)) == 3) {
                $qtr = "Q4";
            }
            //fin year
            $currentDate = Carbon::now();
            $currentYear = date('Y', strtotime($item->pi_date));;
            ...
            $data[] = array(
                ...
                'Budiness Category' => $item->new_category_name,
                ...
                'Qtr' => $qtr,
                'CY(Calender Year)' => date('Y', strtotime($item->pi_date)),
