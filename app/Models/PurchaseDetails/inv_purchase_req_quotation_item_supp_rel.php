...
class inv_purchase_req_quotation_item_supp_rel extends Model
{
    ...
    function get_item_single($condition){
        ...
        'inv_unit.unit_name','inventory_rawmaterial.short_description','inv_purchase_req_item_approve.approved_qty','inventory_gst.igst','inventory_gst.sgst','inventory_gst.cgst','inventory_gst.gst','currency_exchange_rate.currency_code' ])
        ->join('inv_purchase_req_item','inv_purchase_req_item.requisition_item_id','=','inv_purchase_req_quotation_item_supp_rel.item_id')
