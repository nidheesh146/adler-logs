...
class inv_mrd_item extends Model
{
    ...
    function get_item($condition){
        return $this->select('inv_mrd_item.id as id','inv_miq_item.expiry_control','inv_miq_item.expiry_date','inventory_rawmaterial.item_code','inventory_rawmaterial.discription','inv_item_type.type_name','inv_supplier_invoice_item.order_qty',
                    'inv_unit.unit_name','inv_lot_allocation.lot_number','inv_miq_item.value_inr','inv_supplier_invoice_item.rate','inv_supplier_invoice_item.discount','inv_mrd_item.rejected_quantity','inv_mrd_item.remarks','inv_miq_item.invoice_item_id as invoice_item',
