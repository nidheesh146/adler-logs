...
class inv_mrd_item extends Model
{
    ...
    function get_items($condition){
        return $this->select('inv_mrd_item.id as id','inv_miq_item.expiry_control','inv_miq_item.expiry_date','inventory_rawmaterial.item_code',
        ...
        'inv_mrd_item.rejected_quantity','inv_mrd_item.remarks','inv_miq_item.conversion_rate','inv_mrd_item.conversion_rate as mrd_conversion_rate')
                    ...
                    ->distinct('inv_mrd_item.id')
                    ->get();
    }
    public function get_items_for_rmrn($condition)
    {
        return $this->select('inv_mrd_item.id as id','inv_miq_item.expiry_control','inv_miq_item.expiry_date','inventory_rawmaterial.item_code',
        'inv_item_type.type_name','inv_unit.unit_name','inv_lot_allocation.lot_number','inv_mrd_item.value_inr','currency_exchange_rate.currency_code',
    ...
    function get_item($condition){
        return $this->select('inv_mrd_item.id as id','inv_miq_item.expiry_control','inv_miq_item.expiry_date','inventory_rawmaterial.item_code','inventory_rawmaterial.discription','inv_item_type.type_name','inv_supplier_invoice_item.order_qty','inv_supplier_invoice_item.id as invoice_item',
                    'inv_unit.unit_name','inv_lot_allocation.lot_number','inv_miq_item.value_inr','inv_supplier_invoice_item.rate','inv_supplier_invoice_item.discount','inv_mrd_item.rejected_quantity','inv_mrd_item.remarks','inv_miq_item.invoice_item_id',
                    'inv_mrd_item.currency','inv_mrd_item.value_inr','inv_miq_item.conversion_rate','inv_mrd_item.conversion_rate as mrd_conversion_rate','currency_exchange_rate.currency_code','currency_exchange_rate.currency_id')
                    ->leftjoin('inv_mrd_item_rel','inv_mrd_item_rel.item','=','inv_mrd_item.id')
                    ->leftjoin('inv_supplier_invoice_item','inv_supplier_invoice_item.id','=','inv_mrd_item.invoice_item_id')
                    ->leftjoin('inv_miq_item','inv_miq_item.invoice_item_id','=','inv_supplier_invoice_item.id')
                    ->leftjoin('inv_purchase_req_item','inv_purchase_req_item.requisition_item_id','=','inv_supplier_invoice_item.item_id')
