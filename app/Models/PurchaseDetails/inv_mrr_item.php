...
class inv_mrr_item extends Model
{
    ...
    function get_items($condition){
        ...
        'inv_lot_allocation.lot_number','inv_miq_item.value_inr','currency_exchange_rate.currency_code','inv_mac_item.accepted_quantity','inv_purchase_req_item.actual_order_qty',
        'inv_supplier_invoice_item.order_qty as received_qty','inv_mrd_item.rejected_quantity','inv_mrd_item.remarks as rejection_reason')
