...
class inv_mrr_item extends Model
{
    ...
    function get_items($condition){
        return $this->select('inv_mrr_item.id as id','inv_miq_item.expiry_control','inv_miq_item.expiry_date','inventory_rawmaterial.item_code','inventory_rawmaterial.discription as item_description','inv_item_type.type_name','inv_unit.unit_name',
        'inv_lot_allocation.lot_number','inv_miq_item.value_inr','currency_exchange_rate.currency_code','inv_mac_item.accepted_quantity','inv_purchase_req_item.actual_order_qty','inv_supplier_invoice_item.rate','inv_miq_item.conversion_rate',
        'inv_supplier_invoice_item.order_qty as received_qty','inv_mrd_item.rejected_quantity','inv_mrd_item.remarks as rejection_reason','inv_final_purchase_order_master.po_number','inv_final_purchase_order_master.po_date')
                    ...
                    ->leftjoin('inv_mrd_item','inv_mrd_item.miq_item_id','=','inv_miq_item.id')
