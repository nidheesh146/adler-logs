...
class inv_mrr_item extends Model
{
    ...
    function get_items($condition){
        ...
        'inv_lot_allocation.lot_number','inv_miq_item.value_inr','currency_exchange_rate.currency_code','inv_mac_item.accepted_quantity','inv_purchase_req_item.actual_order_qty as actualqty','inv_final_purchase_order_item.order_qty as actual_order_qty','inv_supplier_invoice_item.rate','inv_supplier_invoice_item.discount','inv_miq_item.conversion_rate',
        ...
        'inv_supplier_invoice_item.is_splited_item','inv_supplier_invoice_item.splited_invoice_item_id')
