...
class inv_purchase_req_item extends Model
{
    ...
    function getItem($condition){
        ...
        'inv_purchase_req_item.discount_percent','inventory_gst.gst','currency_exchange_rate.currency_code','inv_purchase_req_item.net_value','inv_purchase_req_item.basic_value','inventory_rawmaterial.item_code','inventory_rawmaterial.discription','inventory_rawmaterial.hsn_code', 'inventory_rawmaterial.availble_quantity', 'inventory_rawmaterial.opening_quantity', 'inventory_rawmaterial.max_stock', 'inventory_rawmaterial.min_stock', 'inv_item_type.type_name','inv_item_type.id as item_type_id', 'inv_purchase_req_item.remarks','inv_unit.unit_name', 'inv_unit.id as unit_id', 'inv_supplier.id as supplierId','inv_supplier.vendor_id as vendorId','inv_supplier.vendor_name as vendorName' ])
