...
class fgs_min_item extends Model
{
    ...
    {
        return $this->select('fgs_min_item.*','product_product.sku_code','product_product.discription','product_product.hsn_code','batchcard_batchcard.batch_no','fgs_mrn.mrn_number')
