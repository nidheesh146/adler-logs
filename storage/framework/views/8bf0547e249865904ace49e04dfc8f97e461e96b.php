	...
	<div class="container">
		<div class="az-content-body">
            ...
            <div class="az-content-breadcrumb"> 
                ...
                <?php else: ?>
                CREATE STERILIZATION PRODUCT LABEL
                <?php endif; ?></a></span>
            </div>
			...
			<div class="row">
                ...
                <div class="col-sm-12   col-md-12 col-lg-12 col-xl-12 " style="border: 0px solid rgba(28, 39, 60, 0.12);">
                    ...
                    <form method="POST" action="<?php echo e((isset($title))?url('label/patient-label'):url('label/sterilization-label')); ?>" id="commentForm" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <label>Sterilization Expiry date *</label>
                                 <?php $date= date('Y-m-d', strtotime('+5 years')) ?> 
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adler-erp\resources\views/pages/label/sterilization-product-label.blade.php ENDPATH**/ ?>