		...
		<div class="az-content-body">
			...
			<div class="row">
                ...
                <div class="col-sm-12   col-md-12 col-lg-12 col-xl-12 " style="border: 0px solid rgba(28, 39, 60, 0.12);">
                    ...
                    <form method="POST" action="<?php echo e(url('samplelabel/sterilization-label-2-print')); ?>" id="commentForm" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <input type="date" value="<?php echo e(date('Y-m-d')); ?>" class="form-control" name="manufacturing_date" value="" id="manufacturing_date" >
                            </div><!-- form-group -->
                            
                            <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <label>Sterilization Expiry date *</label>
                                 <?php $date= date('d-m-Y', strtotime('+5 years')) ?> 
                                <input type="text"  value="<?php echo e(date('d-m-Y', strtotime($date .' -1 day'))); ?>" class="form-control" name="sterilization_expiry_date" id="sterilization_expiry_date" >
                            </div><!-- form-group -->
...
<script>
  $(function(){
    ...
    $('.batchcard_no').select2({
        ...
        allowClear: true,
        ajax: {
            url: "<?php echo e(url('label/batchcardSearch')); ?>",
    ...
    $("#batchcard_no").on('change', function(e) {
        ...
        var type = "sterile";
        $.get( "<?php echo e(url('label/batchcardData')); ?>/"+batch_no_id, function(res) {
...
//     $(document).ready(function(){
//     $('#manufacturing_date').on('change', function(e) {
//         // Get the month and year from the input
//         var manufacturing_date = $(this).val().split('-');
//         var month = parseInt(manufacturing_date[0]) - 1;  // Adjust to 0-based index
//         var year = parseInt(manufacturing_date[1]);

//         // Set the date to the first day of the entered month
//         var date = new Date(year, month, 1);

//         // Adjust the date by subtracting 1 day and adding 5 years
//         date.setDate(date.getDate() - 1);
//         date.setFullYear(date.getFullYear() + 5);

//         // Format the new date as mm-yyyy
//         var expiry_date = ((date.getMonth() + 1) > 9 ? (date.getMonth() + 1) : '0' + (date.getMonth() + 1)) + '-' + date.getFullYear();
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adler-erp\resources\views/pages/samplelabel/sterilization-label-2.blade.php ENDPATH**/ ?>