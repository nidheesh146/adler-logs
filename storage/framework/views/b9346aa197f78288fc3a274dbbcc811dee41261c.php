...
<?php $SupplierQuotation = app('App\Http\Controllers\Web\PurchaseDetails\PurchaseController'); ?>
  ...
  <br>
	<div class="container">
		<div class="az-content-body">
			...
			<h4 class="az-content-title" style="font-size: 20px;"> Final <?php if(request()->get('order_type')=='wo'): ?> Work <?php else: ?> Purchase <?php endif; ?> Order
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12" style="margin: 0px;">
                            <label style="color: #3f51b5;font-weight: 500;margin-bottom:2px;">
                                <i class="fas fa-address-card"></i>  Add Final <?php if(request()->get('order_type')=='wo'): ?> Work <?php else: ?> Purchase <?php endif; ?> Order 
                            </label>
                            
                        </div>
                    </div>
                    <form method="post" action="<?php echo e(url('inventory/final-purchase-insert')); ?>">
					...
					<div class="table-responsive">
						<table class="table table-bordered mg-b-0" id="example1">
                            ...
                            <?php $__currentLoopData = $data['quotation']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							    <tr>
									<td><input type="checkbox" class="quotation_id" id="quotation_id" name="quotation_id[]" value="<?php echo e($item['quotation_id']); ?>"></td> 
									<td><input type="hidden" id="quotation_no" name="quotation_no[]" value="<?php echo e($item['rq_no']); ?>"><?php echo e($item['rq_no']); ?></td>
									<td><input type="hidden" id="date" name="date[]" value="<?php echo e($item['date'] ? date('d-m-Y',strtotime($item['date'])) : '-'); ?>"><?php echo e($item['date'] ? date('d-m-Y',strtotime($item['date'])) : '-'); ?></td>
									<td><input type="hidden" id="delivery_schedule" name="delivery_schedule[]" value="<?php echo e($item['delivery_schedule'] ? date('d-m-Y',strtotime($item['delivery_schedule'])) : '-'); ?>"><?php echo e($item['delivery_schedule'] ? date('d-m-Y',strtotime($item['delivery_schedule'])) : '-'); ?></td>
									<td>
	...
	$('.search-btn').on( "click", function(e)  {
		...
		if(!rq_no & !po_no & !from)
		{
			e.preventDefault();
                ...
                $.ajax ({
                    type: 'GET',
                    url: "<?php echo e(url('getSGSTandCGST')); ?>",
                    data: { id: '' + igst + '' },
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adler-erp\resources\views/pages/purchase-details/final-purchase/final-purchase-add.blade.php ENDPATH**/ ?>