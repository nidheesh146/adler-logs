...
<div class="az-content az-content-dashboard">
                    ...
                    <form method="POST" id="commentForm" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                ...
                                <input type="date" value="<?php echo e(date('Y-m-d')); ?>" class="form-control datepicker" name="order_date" value="" placeholder="">
                            </div>
                            ...
                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                ...
                                <select class="form-control" name="order_fulfil">
                                    ...
                                    <?php $__currentLoopData = $order_fulfil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($type['id']); ?>"><?php echo e($type['order_fulfil_type']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                ...
                                <select class="form-control" name="transaction_type">
                                    <!-- <option>Select one...</option> -->
                                    <?php $__currentLoopData = $transaction_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($type['id']); ?>"><?php echo e($type['transaction_name']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
    ...
    <select class="form-control" name="new_product_category">
        ...
        <option value="<?php echo e($category->id); ?>"
            <?php if(!empty($grs) && ($grs->new_product_category == $category->id)): ?> selected="selected" <?php endif; ?>>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-group col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                ...
                                <input type="date" value="<?php echo e(date('Y-m-d')); ?>" class="form-control oef_date" id="oef_date" name="oef_date" placeholder="">
                            </div><!-- form-group -->
                            <div class="form-group col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                <label>Due Date *</label>
                                <?php $date= date('Y-m-d', strtotime('+30 days')) ?>
                                <input type="text" value="<?php echo e(date('d-m-Y', strtotime($date))); ?>" class="form-control due_date" id="due_date" name="due_date" placeholder="">
                            </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adler-erp\resources\views/pages/FGS/OEF/OEF-add.blade.php ENDPATH**/ ?>