		...
		<div class="az-content-body">
			...
			<div class="row">
                ...
                <div class="col-sm-12   col-md-12 col-lg-12 col-xl-12 " style="border: 0px solid rgba(28, 39, 60, 0.12);">
                    ...
                    <form method="POST" id="commentForm" action="<?php echo e(url('label/snn-mrp-label')); ?>">
  ...
  $(function(){
    ...
    $("#commentForm").validate({
        ...
        $('#sku_code').focusout(function(){
            ...
            $.get( "<?php echo e(url('label/getBatchcard')); ?>/"+sku_code, function(res) {
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adler-erp\resources\views/pages/label/snn-mrp-label.blade.php ENDPATH**/ ?>