                    ...
                    <form method="POST" id="commentForm" autocomplete="off" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                ...
                                <input type="text"  class="form-control  grs_number" name="grs_number" value="<?php echo e($grs['grs_number']); ?>"placeholder="">
                                <input type="hidden"  class="form-control  grs_id" name="grs_id" value="<?php echo e($grs['id']); ?>">
                            </div><!-- form-group -->
                            <?php endif; ?>
                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <label for="exampleInputEmail1">Customer  *</label>
                                <?php if(!empty($grs)): ?>
                                <input type="text" class="form-control  grs_number" value="<?php echo e($grs['firm_name']); ?>" readonly>
                                <?php else: ?>
                            ...
                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                ...
                                <textarea name="billing_address" class="form-control" id="billing_address" readonly><?php if(!empty($grs)): ?> <?php echo e($grs['shipping_address']); ?> <?php endif; ?></textarea>
                            </div> 
                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <label for="exampleInputEmail1">Customer Shipping Address</label>
                                <textarea name="shipping_address"  class="form-control" id="shipping_address" readonly><?php if(!empty($grs)): ?> <?php echo e($grs['billing_address']); ?> <?php endif; ?></textarea>
                            </div>
                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
    <label for="exampleInputEmail1">OEF Number *</label>
    <?php if(!empty($grs)): ?>
        <input type="text" class="form-control" name="" value="<?php echo e($grs['oef_number']); ?>" readonly>
    <?php else: ?>
        <select class="form-control oef_number" name="oef_number" id="oef_number" required>
            <option value="">Select One</option>
            <?php $__currentLoopData = $data['oef_numbers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oef): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($oef->id); ?>"><?php echo e($oef->oef_number); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    <?php endif; ?>
</div> 
<div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
    ...
    <?php if(!empty($grs)): ?>
        <input type="text" class="form-control" name="" value="<?php echo e($grs['category_name']); ?>" readonly>
    <?php else: ?>
...
<div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
    ...
    <?php if(!empty($grs)): ?>
        <input type="text" class="form-control" name="" value="<?php echo e($grs['new_category_name']); ?>" readonly>
    <?php else: ?>
...
<div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
    ...
    <?php if(!empty($grs)): ?>
        <input type="text" class="form-control" value="<?php echo e($grs['location_name1']); ?>" readonly>
    <?php else: ?>
        <select class="form-control" name="stock_location1" id="stock_location1" onchange="handleLocationChange()">
            <option value="">Select one...</option>
            <?php $__currentLoopData = $data['locations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($loc['location_name'] != 'MAA (Material Allocation Area)' && $loc['location_name'] != 'Quarantine' && $loc['location_name'] != 'Loaner' && $loc['location_name'] != 'Other' && $loc['location_name'] != 'Ganga' && $loc['location_name'] != 'Medilink'): ?>
    ...
    <input type="text" 
           ...
           readonly>
                            ...
                            <div class="form-group col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                ...
                                <input type="text" class="form-control datepicker grs_date" name="grs_date" value="<?php if((!empty($grs)) && ($grs['grs_date'])): ?> <?php echo e(date('d-m-Y', strtotime($grs['grs_date']))); ?> <?php else: ?> <?php echo e(date('Y-m-d')); ?> <?php endif; ?>"placeholder="">
                            </div><!-- form-group -->
                        </div> 
                        <div class="row">
...
$(document).ready(function() {
    $('#oef_number').change(function() {
        ...
        if (oefNumber) {
            $.ajax({
                url: "<?php echo e(route('fetch.product.category')); ?>",
                type: "GET",
...
$(document).ready(function() {
    $('#oef_number').change(function() {
        ...
        if (oefNumber) {
            $.ajax({
                url: "<?php echo e(route('fetch.business.category')); ?>", // Use the named route
                type: "GET",
                data: { oef_number: oefNumber },
                success: function(data) {
...
<script>
  ...
  //  .datepicker('update', new Date());
    ...
    //       allowClear: true,
    //       ajax: {
    //       url: "<?php echo e(url('fgs/GRS/find-oef-number-for-grs')); ?>",
    ...
    //     if(res){
    //       $.get("<?php echo e(url('fgs/GRS/find-oef-info')); ?>?id="+res.id,function(data){
    ...
    $('.oef_number').on('change',function(e){
        ...
        if(oef_id!=0)
        {
            $.get("<?php echo e(url('fgs/GRS/find-oef-info')); ?>?id="+oef_id,function(data){
                $('.oef-info-binding').html(data);
                $('.spinner-button').hide();
            });
        }
    ...
    $(".customer").select2({
            ...
            allowClear: true,
            ajax: {
                url: "<?php echo e(url('fgs/customersearch')); ?>",
                processResults: function(data) {
                    return {
                        results: data
                    };
            ...
            if (typeof(res) != "undefined") {
                if (res.dl_expiry_date) 
                {
                    ...
                    if (daysDifference <= 30 && daysDifference > 0) {
                        ...
                        $.get("<?php echo e(url('fgs/GRS/find-oef-number-for-grs')); ?>?customer_id=" + res.id, function(data) {
                            if (data != 0) {
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adler-erp\resources\views/pages/FGS/GRS/GRS-add.blade.php ENDPATH**/ ?>