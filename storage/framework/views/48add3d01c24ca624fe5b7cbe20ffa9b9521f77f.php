            ...
            <div class="card card-dashboard-twentytwo">
              <div class="media">
                ...
                <div class="media-body">
                  <h6><?php echo e($pendingreq); ?></small></h6>
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
            <div class="card card-dashboard-twentytwo">
              <div class="media">
                ...
                <div class="media-body">
                  <h6><?php echo e($supplier); ?></small></h6>
                  <span>suppliers</span>
                </div>
              </div>
              <div class="chart-wrapper">
...
<script>
  ...
  //  .datepicker('update', new Date());
    ...
    $('.primary_sku_batchards').select2({
        ...
        allowClear: true,
        ajax: {
            url: "<?php echo e(url('inventory/stock/find-batchcard')); ?>",
            processResults: function (data) {
                return { results: data };
            }
        }
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adler-erp\resources\views/pages/dashboard/dashboard.blade.php ENDPATH**/ ?>