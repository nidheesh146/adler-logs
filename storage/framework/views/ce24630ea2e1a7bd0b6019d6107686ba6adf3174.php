	...
	<div class="container">
		<div class="az-content-body">
			<div class="az-content-breadcrumb"> 
                ...
                <span><a href=""><?php if(request()->get('order_type')=='wo'): ?> Work <?php else: ?> Purchase <?php endif; ?> Order Approval</a></span>
			</div>
			<h4 class="az-content-title" style="font-size: 20px;"><?php if(request()->get('order_type')=='wo'): ?> Work <?php else: ?> Purchase <?php endif; ?> Order Approval
		   ...
		   <?php endif; ?>
            ...
            <div class="row row-sm mg-b-20 mg-lg-b-0">
                ...
                <div class="tab-pane active show " id="purchase">
                        <form autocomplete="off" action="<?php echo e(url('inventory/final-purchase/approval')); ?>?order_type=<?php echo e(request()->get('order_type')); ?>" method="POST" id="approve-form">
                            ...
                            <table class="table table-bordered mg-b-0" id="example1">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Created By</th>
                                        <th>Action</th>
                                        <?php if(request()->get('status')==4 || request()->get('status')==5 || !request()->get('status')): ?>
                                        <th>Status Change</th>
                                        <?php endif; ?>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr style="	<?php if($po_data->status == 5): ?>
                                        ...
                                        <div class="dropdown-menu">
                                            <?php if($po_data->status!=0 && $po_data->status!=1): ?>
                                            <a href="#" data-toggle="modal"  po="<?php echo e($po_data->po_number); ?>" status="<?php echo e($po_data->status); ?>" orderqty="" value="<?php echo e($po_data->po_id); ?>" data-target="#approveModal" id="approve-model" class="approve-model dropdown-item "><i class="fa fa-check-circle"></i> Approve</a>
                                            <?php endif; ?>
                                        ...
                                        <td style="width:12%;" class="checkbox-group">
                                            <?php if($po_data['status']==4 || $po_data['status']==5 ): ?>
                                            <input type="checkbox" class="item-select-radio check-approve bg-success text-white approve" id="check-approve" name="check_approve[]" value="<?php echo e($po_data['id']); ?>" style="color:green;">
                                            <input type="checkbox" class="item-select-radio check-hold bg-warning text-dark hold"  id="check-hold" <?php if($po_data['status'] == 5): ?>  checked <?php endif; ?> name="check_hold[]" value="<?php echo e($po_data['id']); ?>" style="color:yellow;">
                                            <input type="checkbox" class="item-select-radio check-reject bg-danger text-white reject" id="check-reject" name="check_reject[]" value="<?php echo e($po_data['id']); ?>" style="color:red;">
                                            <?php endif; ?>
                                        </td>
                                    <?php endif; ?>
                                    </tr>
            ...
            <form id="status-change-form" method="post" action="<?php echo e(url('inventory/final-purchase/change/status')); ?>">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"># <?php if(request()->get('order_type')=="wo"): ?> Work Order <?php else: ?> Purchase Order <?php endif; ?> Approval<span class="po_number"></span></h4>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adler-erp\resources\views/pages/purchase-details/final-purchase/final-purchase-approval.blade.php ENDPATH**/ ?>