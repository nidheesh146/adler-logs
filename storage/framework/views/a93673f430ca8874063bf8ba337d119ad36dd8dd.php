  ...
  <div class="container-fluid">
    ...
    <div class="az-header-right">
      ...
      <div class="dropdown az-profile-menu">
        ...
        <a href="<?php echo e(url('logout')); ?>" class="dropdown-item"><i class="typcn typcn-power-outline"></i> Sign Out</a>
        </div><!-- dropdown-menu -->
      </div>
    </div><!-- az-header-right -->
  </div><!-- container -->
</div><!-- az-header -->
<?php /**PATH C:\xampp\htdocs\adler-erp\resources\views/includes/header.blade.php ENDPATH**/ ?>