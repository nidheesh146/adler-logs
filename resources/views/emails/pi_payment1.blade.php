    ...
    <div class="row3">
        <table border="1" cellpadding="0" cellspacing="0" width="200px" style="border-collapse:collapse;">
            ...
            <tr style="text-align: center;font-size:16px;">
                ...
                <td>{{$pi->pi_number}}</td>
                <td>{{date('d-m-Y', strtotime($pi->pi_date))}}</td>
                <td>{{(round(number_format((float)($total-$total_discount+$total_igst+$total_sgst+$total_sgst), 2, '.', '')))}}.00</td>
            </tr>
            </tbody>
        </table>
    </div><br>
