  ...
  <div class="az-sidebar">
    ...
    <div class="az-sidebar-body">
      <ul class="nav">
        ...
        'Supplier.add_supplier','Purchase.viewFinalPurchase','Purchase.add1FinalPurchase','Purchase.editFinalPurchase','Purchase.purchaseOderApproval'])) {{'active show'}} @endif ">
