  ...
  <div class="az-sidebar">
    ...
    <div class="az-sidebar-body">
      <ul class="nav">
        ...
        'MRD.MRDlist','MRD.MRDAdd','MRD.MRDAddItemInfo','MRD.RMRNlist','MRD.RMRNAdd','Stock.StockToProduction','Stock.StockToProductionAdd','MAC.WOAAdd','MRD.WORAdd'])){{'active show'}} @endif ">
