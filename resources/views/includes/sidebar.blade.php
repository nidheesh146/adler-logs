  ...
  <div class="az-sidebar"> 
    ...
    <div class="az-sidebar-body">
      <ul class="nav">
        ...
        'MRD.MRDlist','MRD.MRDAdd','MRD.MRDAddItemInfo','MRD.RMRNlist','MRD.RMRNAdd','Stock.StockToProduction','Stock.StockToProductionAdd','MAC.WOAAdd','MRD.WORAdd','Stock.StockFromProduction','Stock.StockFromProductionAdd','Stock.StockTransfer','Stock.StockTransferAdd','Stock.DirectSIP','Stock.IndirectSIP','Stock.SIPview','MIQ.QuarantineReport'])){{'active show'}} @endif ">
          ...
          <li class="nav-sub-item  @if(in_array($Action,['Purchase.supplierInvoice','Purchase.supplierInvoiceAdd','Purchase.supplierInvoiceItemEdit'])){{'active'}} @endif "><a href="{{url('inventory/supplier-invoice')}}" class="nav-sub-link">Supplier Invoice</a></li>
            ...
            <li class="nav-sub-item  @if(in_array($Action,['MIQ.MIQlist','MIQ.MIQAdd','MIQ.MIQAddItemInfo','MIQ.MIQAddItemInfo'])){{'active'}} @endif "><a href="{{url('inventory/MIQ')}}" class="nav-sub-link">MIQ</a></li> 
              <li class="nav-sub-item  @if(in_array($Action,['MIQ.QuarantineReport'])){{'active'}} @endif "><a href="{{url('inventory/MIQ/QuarantineReport')}}" class="nav-sub-link"> Quarantine Report</a></li> 
