...
@if (in_array('magazine.list',config('permission'))) 
          ...
          'Magazine.authors','Magazine.add_authors','Magazine.edition','Magazine.article','Magazine.work_order_generate','Magazine.detaild_work_order_generate']) ) {{'active'}} @endif ">
  ...
  @endif
    ...
    @if (in_array('organization.list',config('permission'))) 
      ...
      'Agent.agent_payment','Agent.get_all_agent_transaction','Agent.create_magazine_return','Agent.magazine_return'];
      ?>
      ...
      @if (in_array('subscribers.list',config('permission'))) 
       ...
       @endif
          ...
          @elseif(config('organization')['type'] == 2 || config('organization')['type']  == 3 || config('organization')['type']  == 4 || config('organization')['type']  == 5)
          href="{{url('commission-view-org/'.$Controller->hashEncode(config('organization')['type']))}}?date={{date("m-Y")}}" 
          @endif
          ...
          <li class="nav-item  @if (in_array($Action,['Commission.create','Place.pincode','Place.district','Place.state','Place.postaldevision'])) {{'active'}} @endif ">
            ...
            <div class="az-menu-sub">
              ...
              @endif
              @if (in_array('place.list',config('permission')))  
                <a href="{{url('place/pincode')}}" class="nav-link">Places</a>
              @endif
              </nav>
            </div>
          </li>
      ...
      <div class="az-header-right">
        ...
        <a href="{{url('ticket/open')}}" class="new1"><i class="fas fa-headset"></i></a>
          </div>
        ...
        <div class="dropdown az-header-notification">
          ...
          <div class="dropdown-menu">
            ...
            <p class="az-notification-text">You have {{ count(config('notification'))}}  notification</p>
            <div class="az-notification-list" style="max-height: 500px;overflow-y: scroll;">
             
             @if(count(config('notification')) > 0)
                    @include('includes.header-notification')
             @endif      
