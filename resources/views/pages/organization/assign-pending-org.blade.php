   ...
   <div class="container">
      <div class="az-content-body">
         <div class="az-content-breadcrumb">
            ...
            <span><a href="{{ url('/org/pending') }}" > Pending </a></span>
            <span> Assign Organization </span>
         </div>
         <h4 class="az-content-title" style="font-size: 20px;">Assign {{$data['organization']['org_number']}} - {{$data['organization']['org_name']}} ( {{ucfirst($org)}} Organization )</h4>
               ...
               <div class="row">
                  ...
                  <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                     ...
                     <input type="text" name="owner_name" class="form-control"
                        placeholder="Enter Owner name (optional)" value="{{$data['organization']['org_owner_name']}}">
                  </div>
                  <!-- form-group -->
                  ...
                  <div class="form-group col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <textarea class="form-control" readonly name="Comments" >{{$data['organization']['comment']}}</textarea>
                 </div>
               </div>
                  ...
                  <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 ">
                     ...
                     <select class="form-control  under_state" name="state">
                        ...
                        @foreach ($data['state'] as $state)
                           <option value="{{$state['org_id']}}"  >{{$state['org_number']}}-{{$state['org_name']}}</option>
                        @endforeach
                     </select>
                  </div>
                  @endif
