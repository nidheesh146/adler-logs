    ...
    <div class="container">
	    <div class="az-content-body"  style="color:black;">     
            ...
            <div class="label-div" id="label-div">
                <?php
                    $label_per_page =30;
                    $page_count = (int)($no_of_label/30);
                    $remaining = $no_of_label%30;
                 ?>
                ...
                <div class="page-container" style="margin-top:5mm;margin-bottom:0cm;width:21.1cm;height:29.3cm;margin-left:2px">
                    ...
                    <div class="label-container" style="float:left;width:66.25mm;height:27.29mm;margin-left:12px;margin-top:3px;margin-bottom:7.3px" >
                        <div class="sub-columns" style="">
                            <div class="" style="width:7px;text-align: justify;">
                                <span class="smalltext" style="font-size:5px;float: left;writing-mode: vertical-lr;transform: rotate(180deg); margin-top:20%;margin-right:1px;margin-left:4px;">
                            ...
                            <div class="col-md-9 sub-column" style="width:64%;float: left; margin-left:2px;line-height:65%;">
                                ...
                                <span class="smalltext" style=" font-size:6.5px;">{{$batchcard_data->discription}}</span><br/>
                                @endif
