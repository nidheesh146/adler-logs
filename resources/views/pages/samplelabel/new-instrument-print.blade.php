    ...
    <div class="container">
	    <div class="az-content-body">     
            ...
            <div class="label-div" id="label-div" style="margin:0px; padding:0px;">
                ...
                <div class=" column " style="height:16%;float:left;width: 48%;padding:0px 2px;font-size:13px; margin-left:10px;@if($j==11 || $j==12) margin-bottom:0px; @else margin-bottom:11.3px;  @endif @if ($j%2==1)transform: rotate(180deg); margin-top:-8;@endif">
                    <div class="subcolumn1" style="float:left;width:95%; height:content-fit;">
                        <div class="sub1" style="float:left;width:content-fit;font-weight:bold;">
                            <img src="{{asset('/img/alderlogo/IFU.png')}}" style="float:left; height:81px;margin-left:55%;">
                        </div> 
                        
                        <div class="sub2" style="float:left;width:8%;padding:1px;height:70px">
                            <span class="smalltext" style="font-size:4.7px;font-weight:500;text-align: center;writing-mode: vertical-lr;transform: rotate(180deg);margin-left:60%;margin-top:5px;">
                    ...
                    <div class="subcolumn2" style="float:left;margin-top:1px;">
                        <div style="float:left;width:40%;">
                            <div class="barcode2" style="font-size:5.6px">
                                <img src="data:image/png;base64,{{ base64_encode($label_batch_combo_barcode)}}" style="width:95%;height:22px;margin-left:17px;">   
                                <br/>
                        ...
                        <div class="barcode" style="width:30%;float:left;font-size:5.6px">
                            <img src="data:image/png;base64,{{ base64_encode($manf_date_combo_barcode)}}" style="width:95%;margin-left:27px;">   
                            <br/>
                            <div style="text-align:center;margin-top:1px;font-size:6.2px;font-weight:550;margin-left:30px;">{{$manf_date_combo}}</div>
                        </div>
                        <div style="float:left;width:15%; margin-left:1px;">
                            <div class="logo" style="text-align:center;">
                                <img src="{{asset('/img/alderlogo/instruction_use.png')}}"  style="width:40%;float:left;padding:0px;margin-left: 45px;">
