    ...
    <div class="container">
        <div class="az-content-body">     
            ...
            <div class="label-div" id="label-div" style="margin:0px; padding:0px;">
                ...
                <div class=" column " style="height:16%;float:left;width: 48%;padding:0px 2px;font-size:13px; margin-left:15px;@if($j==11 || $j==12) margin-bottom:0px; @else margin-bottom:11.5px;@endif @if($j%2==1)transform: rotate(180deg);margin-top:-21px; margin-left:-10px;@endif">
                    <div class="subcolumn1" style="float:left;width:95%; height:content-fit;">
                        ...
                        <div class="sub2" style="float:left;width:8%;padding:1px;height:70px;margin-left:-5px">
                        ...
                        <div class="sub3" style="float:left;width:45%;padding:1px;font-size:8px;line-height:1.1;margin-left:7px;">
                    ...
                    <div class="subcolumn2" style="float:left;margin-top:1px;">
                        <div style="float:left;width:40%;">
                            <div class="barcode2" style="font-size:5.6px">
                                <img src="data:image/png;base64,{{ base64_encode($label_batch_combo_barcode)}}" style="width:95%;height:22px; margin-left:30px;">   
                                <br/>
                                <div style="text-align:center;margin-top:1px;font-size:6.2px;font-weight:550">{{$label_batch_combo}}</div>
                            </div>
                        </div>
                        <div class="barcode" style="width:30%;float:left;font-size:5.6px; margin-left:30px;">
                            <img src="data:image/png;base64,{{ base64_encode($manf_date_combo_barcode)}}" style="width:92%;">   
                            <br/>
                        ...
                        <div style="float:left;width:83%;">
                            <div class="barcode3"  style="float:left;margin-top:4px;">
                                ...
                                <div style="margin-left:2px;float:left;">
                                    ...
                                    <span style="font-size:6px; padding-left:2px;font-weight:bold;display:block;margin-top:-4px;margin-left:12px;">{{$batchcard_data->drug_license_number}}</span> 
