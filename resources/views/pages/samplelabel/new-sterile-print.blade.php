...
<div class="az-content az-content-dashboard">
  <br>
    <div class="container">
	    <div class="az-content-body" style="color:black;">     
            ...
            <div class="row columns">
                ...
                <div class="label-div" id="label-div" style="margin-top:30px;margin-right:5px">
                    @for ($i = 0; $i< $page_count; $i++)
                    <!-- <div class="page-container" style="margin-top:1cm;argin-bottom:-5cm;width:21.1cm;height:29.3cm;"> -->
                    <div class="page-container" style="margin-top:1cm;margin-bottom:-5cm;width:23cm;height:29.9cm;">
                        @for ($j=0;$j<$label_per_page;$j++)
                         <!-- <div class="label-container" style="float:left;width:10.2cm;height:6cm;margin-bottom:0.08cm;margin-top:0.08cm;">  -->
                        <!-- <div class="label-container" style="float:left;width:50%;height:25%;margin-bottom:0.14cm;margin-top:0.09cm;">  -->
                         <div class="label-container" style="float:left;width:50%;height:25%;margin-bottom:45px;margin-left:5px;margin-right:-5px;@if($j%2==0)transform: rotate(180deg);margin-top:-45px;@endif"> 
                            
                            <div class="row1" style="font-size:12px;">    
                                <div class="subcolumn1" style="float:left; width:60px">
                                    <div class="logo" style="text-align:center;">
                                        <img src="{{asset('/img/logo.png')}}"  style="width:78%;margin-left:33px;">
                                    </div>
                                    <div class="icons" style="margin-top:5px;margin-left:-35px; text-align:center;">
                                        <!-- @if($batchcard_data->is_donot_reuse_logo==1)70 29 -->
                                         <img src="{{asset('/img/alderlogo/dot_not_reuse.png')}}"  style="width:22%;margin-left:10px;margin-right:0px;">
                                        <!-- @endif
                                        @if($batchcard_data->is_read_instruction_logo==1) -->
                                        <img src="{{asset('/img/alderlogo/instruction_use.png')}}"  style="width:22%;margin-left:1px;margin-right:-70px;margin-bottom:-1px;"> 
                                        <!-- @endif -->
                                ...
                                <div class="subcolumn2" style="float:left;width:300px;margin-left:20px">
                                    <div class="subdiv">
                                    ...
                                    <div class="subdiv" style="margin-top: -3px;">
                                        <div class="group" style= "font-weight:400;overflow:hidden;max-height:40px;width: 95%;;padding:2px;border-bottom: 1.5px solid black;border-top: 1.5px solid black; margin-top:60px;font-size:10px;">
                                           <div style="margin-top: -1px;"> {{$batchcard_data->groups}}<br/></div>
                                        <div style="margin-top: -1px;">{{$batchcard_data->discription}}
                                        </div>
                                        </div>
                                    </div>
                                    <div class="subdiv" style="margin-top:2px;">
                                        <div class="ss" style="float:left;width:150px; font-size:11px;">
                                           ...
                                           <!-- the barcoode -->
                                            <img src="data:image/png;base64,{{ base64_encode($sku_code_barcode)}}" style="margin-top:1px;margin-left:145px;width:140px;">
                                            <br/>
                                            <small><span style="margin-left:190px;font-weight:550">{{$batchcard_data->sku_code}}</span></small>
                                            <br/>
                                ...
                                <div class="subcolumn3" style="float:right;width:5px;">
                                    <span class="smalltext" style="font-size:8px;margin-top:75px;margin-left: -30px; float: left;writing-mode: vertical-lr;transform: rotate(180deg);">
    ...
    <div class="prdct_img" style="text-align:center; margin-top:30px;">
        @if($batchcard_data->label_image)
            <?php $img_path = '/img/'.$batchcard_data->label_image; ?>
            @if(file_exists(public_path($img_path))) 
            <img src="{{asset($img_path)}}" style="width:55%;margin-top:-25px; margin-left:-5px;margin-right:-30px;">
            @endif
        @endif
    </div>
</div>
                                ...
                                <div class="subcolumn2" style="float:right; width:300px;margin-right:12px;">
                                    <div class="foot" style="display:block;float:left;"> 
                                        <div class="img" style="">
                                            <img src="{{asset('/img/alderlogo/manufactured_address.png')}}" style="width:40px;height:22px;margin-top:25px;">
                                        </div>
                                        &nbsp;
                                        <div style="font-size:8px;margin-left:51px;margin-top:-60px; margin-bottom:10px; padding-bottom:4.5px;">
                                                {{$batchcard_data->drug_license_number}}
                                            </div>
                                       <div class="address" style="float:left;line-height:0.95;margin-left:49.5px;margin-top:-3px;">
                                            <span class="cls" style="font-size:8px;font-weight:bold;">ADLER HEALTHCARE PVT. LTD</span>
                                            <br/>
                                            <span style="font-size:8px;margin-bottom:10px;">
                    ...
                    <div class="page-container" style="margin-top:1cm;margin-bottom:-5cm;width:23cm;height:29.9cm;">
                        ...
                        <div class="label-container" style="float:left;width:50%;height:25%;margin-bottom:45px;margin-left:20px;margin-right:-5px;@if($j%2==1)transform: rotate(180deg);margin-top:-50px; margin-left:-10px;@endif"> 
                        <div class="label-content{{$j}}" style="">
                            <div class="row1" style="font-size:12px;">    
                                <div class="subcolumn1" style="float:left; width:60px">
                                    <div class="logo" style="text-align:center;">
                                ...
                                <div class="subcolumn1" style="float:left; width:79px;display: inline-block;">
                                    ...
                                    @if($batchcard_data->label_image)
                                        ...
                                        @if(file_exists(public_path($img_path))) 
                                            ...
                                            <img src="{{asset($img_path)}}" style="width:55%;margin-top:-25px; margin-left:-20px;margin-right:-25px;">
...
//$("#print").on("click", function () {
    ...
    mywindow.document.write(document.getElementById("label-div").innerHTML);
