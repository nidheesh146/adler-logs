	...
	<div class="container">
		<div class="az-content-body">
            ...
            <div class="az-content-breadcrumb"> 
                ...
                @else
                CREATE NEW STERILIZATION PRODUCT LABEL
                @endif</a></span>
            </div>
            ...
            @if(isset($title))
                Create New Patient label
            @else
                Create New Sterilization Label
            @endif
            </h4>
			...
			<div class="row">
                ...
                <div class="col-sm-12   col-md-12 col-lg-12 col-xl-12 " style="border: 0px solid rgba(28, 39, 60, 0.12);">
                    ...
                    <form method="POST" action="{{ (isset($title))?url('samplelabel/new-patient-print'):url('label/new-sterilization-label')}}" id="commentForm" >
                        {{ csrf_field() }}  
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <label>Battch Card *</label>
