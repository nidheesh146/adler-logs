                ...
                @for ($i = 1; $i<= $page_count; $i++)
                 <div style="margin-top:0px;">
                    @for ($j = 1; $j<= $label_per_page; $j++)
                     <div class=" column " style="float:left;width:48%;height:25%;margin-bottom:0px;margin-left:30px;margin-top:15px;;@if($j%2==1)margin-left:-2px;@endif"">
                        <div class="subcolumn1" style="float:left;width:95%; height:content-fit;">
                            <div class="sub1" style="float:left;width:content-fit;font-weight:bold;">
                                    <img src="{{asset('/img/alderlogo/IFU.png')}}" style="float:left; height:125px;width:40px;">
                            </div>

                            <div class="sub2" style="float:left;width:8%;padding:1px;height:90px">
                                <span class="smalltext" style="font-size:5px;font-weight:500;text-align: center;writing-mode: vertical-lr;transform: rotate(180deg);margin-top:18px;">
                                LBL/F-19_REV01_{{strtoupper(date( 'dMY' , strtotime('08-12-2024')) )}}
                                </span>
                               
                            </div>
                            <div class="sub3" style="float:left;width:45%;font-size:9px;line-height:1.3; margin-left:-20px;">
                                ...
                                <span style="font-size:7px;">{{$batchcard_data->snn_description}}</span><br />
                                <span style="font-size:13.5px; display: inline-block;width: 350px;">{{$batchcard_data->ad_sp1}}</span><br>
                                <span style="">{{$batchcard_data->ad_sp2}}</span><br />
                        ...
                        <div class="sub4" style="float:left;width:100%;height:70px;padding:1px;font-size:9px;text-align:center; margin-top:-133px; margin-left:65px;">
                            ...
                            @if($batchcard_data->label_image)
                                ...
                                @if(file_exists(public_path($img_path)))
                                    <img src="{{asset($img_path)}}" style="width: 75px; margin-top:38px;margin-left:80px;">
                                @endif
                            @endif
                        </div>
                    </div>
                    <div class="subcolumn2" style="float:left;margin-top:15px; margin-left: 35px;">
                ...
                <div class="subcolumn3" style="float:left;margin-top:2px;">
                    <div style="float:left;width:83%;">
                        <div class="barcode3" style="float:left;margin-top:4px;">
                            ...
                            <div style="font-size:8px;margin-top:-172px;">
                            <span style="font-size:12px; position: relative;
left: 300px;">MRP: ₹{{ $mrp }} /-</span>
                    </div>
                        </div>
                    </div>
                    <div style="float:left;width:15%; margin-left:1px;">
    ...
    @if($remaining!=0)
        ...
        <div style="margin-top:0mm;">
            @for ($j=1;$j<=$label_per_page;$j++) 
            <div class=" column label-content{{$j}}" style="float:left;width:48%;height:25%;margin-bottom:0px;margin-left:10px;margin-top:5px;">
                <div class="subcolumn1" style="float:left;width:95%; height:content-fit;">
                    <div class="sub1" style="float:left;width:content-fit;font-weight:bold;">
                        <img src="{{asset('/img/alderlogo/IFU.png')}}" style="float:left; height:125px;width:40px;">
                    </div>
                ...
                <div class="subcolumn2" style="float:left;margin-top:1px; margin-left: 35px;">
                    ...
                    <div class="barcode" style="width:30%;float:left;font-size:5.6px">
                        <img src="data:image/png;base64,{{ base64_encode($manf_date_combo_barcode)}}" style="width:95%;">
                        <br />
                        <div style="text-align:center;margin-top:1px;font-size:6px;font-weight:550">
                            {{$manf_date_combo}}
                        </div>
                    </div>
                    <div style="float:left;width:15%; margin-left:1px;">
