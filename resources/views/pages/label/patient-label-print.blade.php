    ...
    <div class="container">
	    <div class="az-content-body">     
            ...
            <div class="row label-div columns" id="label-div">
                ...
                <div class=" column" style=" height:6.56%;float: left;width: 28%;border-style: ridge;border-color:#f0f0f5 ;margin:5px;padding:1px;">
                        <div class="sub-columns" >
                            ...
                            <div class="col-md-9 sub-column" style="width:70%;float: left; margin-left:2px;">
                                ...
                                <img src='/img/alderlogo/sterile_eo.png' alt="image">
                            ...
                            <div class="col-md-3 sub-column" style="width:25%;float: left" >
                                <div class="img-wrapper" style="margin-top:60px;text-align:center;">
                                    <img src="{{asset('/img/alderlogo/manufactured_address.png')}}" style="width:30px;">
                                    <img src="{{asset('/img/alderlogo/alder_logo.png')}}"  style="width:30px;">
                                </div>
                            </div>
                        </div>
