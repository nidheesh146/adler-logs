    ...
    <div class="container">
	    <div class="az-content-body"  style="color:black;">     
            ...
            <div class="label-div" id="label-div">
                ...
                <div class="page-container" style="margin-bottom:0.45cm;width:21.1cm;height:29.3cm;">
                    @for ($j=0;$j<$label_per_page;$j++)
                    <div class="label-container" style="float:left;width:6.9cm;height:2.45cm;">
                ...
                @endfor
                @if($remaining!=0)
                <!-- <div class="page-container" style="width:21.1cm;height:29.3cm; margin-top:0.9cm;margin-bottom:0.45cm;"> -->
                <div class="page-container" style="width:21.1cm;height:29.3cm;">
                    @for ($j=0;$j<$remaining;$j++)
                    <div class="label-container" style="float:left;width:6.9cm;height:2.45cm;">
                        <div class="sub-columns" style="">
                            <div class="" style="width:5px;text-align: justify;">
                                <span class="smalltext" style="font-size:5px;float: left;writing-mode: vertical-lr;transform: rotate(180deg); margin-top:22%;">
                                LBL/F-{{$batchcard_data->label_format_number}}_REV00_{{date( 'd M y' , strtotime('14-12-2021') )}}
                                </span>
                            </div>
                            <div class="col-md-9 sub-column" style="width:65%;float: left; margin-left:2px;line-height:65%;">
                                ...
                                <div class="" style="display:block;margin-bottom:3px;margin-top:7px;">
                                    <img src="{{asset('/img/alderlogo/expiry_date.png')}}" style="width:8px; height:10px;">
                                    <span class="smalltext" style=" font-size:6.5px;">{{$sterilization_expiry_date}}</span>
                                    <img src="{{asset('/img/alderlogo/manufacturing.png')}}" style="width:14px;height:9px;">
                                    <span class="smalltext" style=" font-size:6.5px;">{{$manufacture_date}}</span>
                                </div>
                            </div>
                            <div class="sub-column" style="width:30%;float: left;margin-top: 40px;margin-left:2px;" >
                                <!-- <div class="width:30%;float: left;margin-top:60px;padding:2px"> -->
