...
<div class="az-content az-content-dashboard">
        ...
        <div class="az-content-body">
            ...
            <div class="label-div" id="label-div" style="margin:0px; padding:0px;">
                @for ($i = 1; $i<= $page_count; $i++)
                 <div style="margin-top:0px;max-height:29.3cm;">
                    @for ($j = 1; $j<= $label_per_page; $j++)
                     <div class=" column " style="height:25%;float:left;width: 48%;padding:0px 2px;font-size:13px; margin-left:10px;">
                ...
                <div class="sub2" style="float:left;width:8%;padding:1px;height:70px">
                    <span class="smalltext" style="font-size:4.7px;font-weight:500;text-align: center;writing-mode: vertical-lr;transform: rotate(180deg);margin-top:5px;">
                        LBL/F-{{$batchcard_data->label_format_number}}_REV01_{{strtoupper(date( 'dMY' , strtotime('01-08-2023')) )}}
                    </span>
                </div>
                <div class="sub3" style="float:left;width:45%;font-size:8px;line-height:1.1; margin-left:-20px;">
                    ...
                    <span style="">{{$batchcard_data->ad_sp1}}</span><br />
                    ...
                    <div style="padding-top:1px;width: fit-content;">
                        ...
                        <div style="text-align:center;font-size:6.2px;font-weight:550;">{{$batchcard_data->sku_code}}
                ...
                <div class="sub4" style="float:left;width:content-fit;height:70px;padding:1px;font-size:9px;text-align:center;">
                    ...
                    <img src="{{asset($img_path)}}" style="width: 35px;">&nbsp;
                    @endif
            ...
            <div class="subcolumn2" style="float:left;margin-top:1px; margin-left: 35px;">
                ...
                <div class="barcode" style="width:30%;float:left;font-size:5.6px">
                    <img src="data:image/png;base64,{{ base64_encode($manf_date_combo_barcode)}}" style="width:80%;">
                    <br />
    ...
    <div style="margin-top:0mm;max-height:29.3cm;">
        @for ($j=1;$j<=$label_per_page;$j++) <div class=" column label-content{{$j}}" style="height:25%;float:left;width: 48%;padding:0px 2px;font-size:13px; margin-left:10px;@if($j==11 || $j==12) margin-bottom:0px; @else margin-bottom:11.5px;  @endif">
            <div class="subcolumn1" style="float:left;width:95%; height:content-fit;">
                <div class="sub1" style="float:left;width:content-fit;font-weight:bold;">
                    <img src="{{asset('/img/alderlogo/IFU.png')}}" style="float:left; height:81px;">
                </div>
