    ...
    <div class="container">
	    <div class="az-content-body">     
           ...
           <input type="hidden" name="batch_id" id="batch_id" value="{{$batchcard_data->batch_id}}">
            ...
            <div class="label-div" id="label-div" style="margin-bottom:5px; margin-top:26px;">
                @for ($i = 1; $i<= $page_count; $i++)
                <div style="margin-top:0px;max-height:25.3cm;">
                @for ($j = 1; $j<= $label_per_page; $j++)
                
                <div class=" column " style="height:13.02%;margin-top:20.3px;margin-bottom:18px;float:left;width: 48%;font-size:10px; margin-left:10px;margin-top:-5px;">
                <div class="row1" style="font-size:8px;">
                                        <div class="subcolumn1" style="float:left; width:50px;">
                                            <div class="logo" style="text-align:center;">
                                                <img src="{{asset('/img/logo.png')}}" style="width:50%;height:25px;">
                                            </div>
                                            <div class="icons" style="margin-top:8px;margin-left:2px; text-align:center;">
                                                <!-- @if($batchcard_data->is_donot_reuse_logo==1)70 29 -->
                                                <img src="{{asset('/img/alderlogo/dot_not_reuse.png')}}" style="width:33%;">
                                                <!-- @endif
                                        @if($batchcard_data->is_read_instruction_logo==1) -->
                                                <img src="{{asset('/img/alderlogo/instruction_use.png')}}" style="width:33%;">
                                                <!-- @endif -->
                                        ...
                                        <div class="subcolumn2" style="float:left;width:250px">
                                            <div class="subdiv">
                                                <div class="ss" style="float:left;width:120px;height:30px;">
                                                    <span style="text-align:left;"><strong>Ref: {{$batchcard_data->sku_code}}</strong></span></br />
                                                    <img src="{{asset('/img/alderlogo/lot.png')}}" style="width:28px;height:10px;">
                                                    {{$batchcard_data->batch_no}}
                                                    <br />
                                                    <div style="margin-top:10px;display: inline;">{{$lot_no}}</div>
                                                    <!-- <img src="{{asset('/img/alderlogo/sterile_r.png')}}" alt="image" style="width:49px;"> -->
                                                    <div style="display:block;float:left;font-family: Arial, sans-serif;font-size:8px;font-weight:350;margin-top:2px;">
                                                    ...
                                                    <br />
                                                    <img src="{{asset('/img/alderlogo/manufacturing.png')}}" style="width:18px;margin-top:7px;margin-left:-40px;height:10px">&nbsp;
                                                    {{$manufacture_date}}
                                                </div>
                                                <div class="ss" style="float:right;width:130px;text-align:center;margin-top:-30px; margin-left:10px;">
                                                    ...
                                                    <div class="box" style="font-size:9px;padding:6px 6px 6px 6px ;border-bottom:0.7px solid black;border-left:0.7px solid black;border-right:0.7px solid black;">
                                            ...
                                            <div class="subdiv">
                                                <div class="group" style="font-weight:180;overflow:hidden;max-height:30px;padding:1px;border-bottom: 1px solid black;border-top: 1px solid black; margin-top:43px;font-size:5px;">
                                            ...
                                            <div class="subdiv" style="margin-top:3px;">
                                                <div class="ss" style="float:left;width:150px; font-size:8px;">
                                                    ...
                                                    <img src="data:image/png;base64,{{ base64_encode($sku_code_barcode)}}" style="margin-top:3px;width:140px; height:15px;">
                                                    <br />
                                                    <small><span style="margin-left:26px;font-weight:350">{{$batchcard_data->sku_code}}</span></small>
                                                    <br />
                                                    <!-- <span style="font-size:7px;margin-left:40px;">ML No:{{$batchcard_data->drug_license_number}}</span> -->
                                                    <div style="font-size:7px;margin-left:22px;margin-top:0px; padding-bottom:5px;">
                                                    &nbsp;{{$batchcard_data->drug_license_number}}
                                                    </div>
                                                </div>
                                                <div class="ss" style="float:right;width:150px;text-align:center;font-size:8px;margin-top:-46px;">
                                        ...
                                        <div class="subcolumn3" style="float:right;width:5px;">
                                            <span class="smalltext" style="font-size:8px;margin-top:0px;margin-left: -14px; float: left;writing-mode: vertical-lr;transform: rotate(180deg);">
                                    ...
                                    <div class="row2" style="height:fit-content; height:80px">
                                        <div class="subcolumn1" style="float:left;width:5px;margin-left:-265px;">
                                            <span class="smalltext" style="font-size:10px;font-weight:bold;margin-top:60px; float: right;writing-mode: vertical-lr;transform: rotate(360deg);">
                                                {{$batchcard_data->sku_code}}
                                            </span>
                                        </div>
                                        <div class="subcolumn2" style="float:left;margin-left:-320px;margin-top:120px; width:70px;display: inline-block;">
                                            <div class="prdct_img" style="text-align:center;">
                                                ...
                                                <img src="{{asset($img_path)}}" style="width:30%;">
                                                @endif
                                                @endif
                                            </div>
                                        </div>
                                        <div class="subcolumn3" style="float:right; width:300px;margin-right:13px;">
                                            <div class="foot" style="display:block;float:left;margin-left:12px;">
                                                <div class="img" style="">
                                                    <img src="{{asset('/img/alderlogo/manufactured_address.png')}}" style="width:36px;height:20px;">
                                                </div>
                                                &nbsp;
                                                <div class="address" style="float:right;line-height:1; margin-left:35px;margin-top: -20px;">
                ...
                @for ($j=1;$j<=$label_per_page;$j++)
                <div class=" column label-content{{$j}}" style="height:16%;float:left;width: 48%;padding:0px 2px;font-size:13px; margin-left:10px;@if($j==11 || $j==12) margin-bottom:0px; @else margin-bottom:11.5px;  @endif">
