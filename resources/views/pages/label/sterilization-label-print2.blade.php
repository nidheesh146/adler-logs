	    ...
	    <div class="az-content-body">     
           ...
           <input type="hidden" name="batch_id" id="batch_id" value="{{$batchcard_data->batch_id}}">
            ...
            <div class="label-div" id="label-div" style="margin-bottom:5px; margin-top:26px;">
                ...
                <div class=" column " style="height:8%;margin-top:0px;@if($j>=11)margin-bottom:0px;@else margin-bottom:99px;@endif;float:left;width: 48%;font-size:10px; margin-left:10px;">
                <div class="row1" style="font-size:8px;">
                                        ...
                                        <div class="subcolumn2" style="float:left;width:220px">
                                            <div class="subdiv">
                                                <div class="ss" style="float:left;width:120px;height:15px;">
                                                    <span style="text-align:left;"><strong>Ref: {{$batchcard_data->sku_code}}</strong></span></br />
                                                    <img src="{{asset('/img/alderlogo/lot.png')}}" style="width:28px;height:8px;">
                                                ...
                                                <div class="ss" style="float:right;width:130px;text-align:center;margin-top:-15px; margin-left:10px;">
                                            ...
                                            <div class="subdiv">
                                                <div class="group" style="font-weight:180;overflow:hidden;max-height:30px;padding:1px;border-bottom: 1px solid black;border-top: 1px solid black; margin-top:43px;font-size:6px;">
                                                    {{$batchcard_data->groups}}<br />
                                                    {{$batchcard_data->discription}}
                                                </div>
                                            </div>
                                            <div class="subdiv" style="margin-top:-1px;">
                                                <div class="ss" style="float:left;width:150px; font-size:8px;">
                                                    <span style="margin-left:25px;margin-top:5px"><strong>{{$batchcard_data->ad_sp1}}</strong></span><br />
                                                    ...
                                                    <br />
                                                    <small><span style="margin-left:0px;font-size:5px;font-weight:350;margin-top:-3px;">{{$batchcard_data->sku_code}}</span></small>
                                                    <br />
                                                    <!-- <span style="font-size:7px;margin-left:40px;">ML No:{{$batchcard_data->drug_license_number}}</span> -->
                                                    <div style="font-size:5px;margin-left:30px;margin-top:-1px; padding-bottom:5px;">
                                                    &nbsp;{{$batchcard_data->drug_license_number}}
                                                    </div>
                                                </div>
                                                <div class="ss" style="float:right;width:150px;text-align:center;font-size:8px;margin-top:-38px;">
                                    ...
                                    <div class="row2" style="height:fit-content; height:80px">
                                        <div class="subcolumn1" style="float:left;width:5px;margin-left:-245px;">
                                            <span class="smalltext" style="font-size:10px;font-weight:bold;margin-top:55px; float: right;writing-mode: vertical-lr;transform: rotate(360deg);">
                                                {{$batchcard_data->sku_code}}
                                            </span>
                                        </div>
                                        <div class="subcolumn2" style="float:left;margin-left:-280px;margin-top:120px; width:70px;display: inline-block;">
                                            <div class="prdct_img" style="text-align:center;">
                                                ...
                                                <img src="{{asset($img_path)}}" style="width:30%;margin-top:-5px;margin-left:-8px;">
                                                @endif
                                                @endif
                                            </div>
                                        </div>
                                        <div class="subcolumn3" style="float:right; width:300px;margin-right:13px;">
                                            <div class="foot" style="display:block;float:left;margin-left:15px;">
                                                <div class="img" style="">
                                                    <img src="{{asset('/img/alderlogo/manufactured_address.png')}}" style="width:32px;height:15px;margin-left:9px;margin-top: -3px">
                                                </div>
                                                &nbsp;
                                                <div class="address" style="float:right;line-height:1; margin-left:39px;margin-top:-15px;">
                                                    <span class=" cls" style="font-size:6px;font-weight:bold;" ;>ADLER HEALTHCARE PVT. LTD</span>
                                                    <br  />
