  ...
  <div class="container">
    <div class="az-content-body">
      ...
      <h4 class="az-content-title" style="font-size: 20px;">Products
        <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('product/Product-add')}}'" class="badge badge-pill badge-dark "><i class="fas fa-plus"></i> Product</button>
      </h4>
        ...
        <div class="table-responsive">
          <table class="table table-bordered mg-b-0" id="example1">
            ...
            <tbody id="prbody1">
              ...
              <tr>
                <td>
                <a href="{{url('product/Product-image/'.$item["id"])}}" target="_blank">
    {{$item['sku_code']}}</a>
               ...
               @if($item['is_active']==1||$item['is_active']==0)
                  ...
                  <div class="dropdown-menu">
                    <a href="{{url('product/Product-add?id='.$item['id'])}}" class="dropdown-item"><i class="fas fa-edit"></i> Edit</a>
                    <a href="{{url('product/delete-input-material?id='.$item['id'])}}" onclick="return confirm('Are you sure you want to delete this ?');" class="dropdown-item"><i class="fas fa-trash-alt"></i> Delete</a>
                  </div>
