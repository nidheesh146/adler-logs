        ...
        <div class="container">
            <div class="az-content-body">
                ...
                <div class="az-content-breadcrumb">
                    ...
                    Manual Cancellation Delivery Challan(CDC)</a></span>
                    <span><a href="" style="color: #596881;">
                           Manual CDC Item</a></span>
                </div>
                            ...
                            <div class="row">
                                ...
                                <table class="table table-bordered">
                                    <tbody id="dynamic_field">
                                        <input type="text" id="cdc_id" value="{{$cdc_id}}" name="cdc_id"> 
                                        <tr id="row1" rel="1">
                                            <td>
                                                <div class="row">
...
//     });
                ...
                $('#dynamic_field').append(`
                      ...
                      <td>
                        ...
                        <div class="row"> 
                            <div class="form-group col-sm-12 col-md-3 col-lg-3 col-xl-3" style="float:left;">
                                <label>Quantity * </label>
                                <input type="number"  class="form-control stock_qty" name="moreItems[${i}][qty]" id="stock_qty${i}" index="${i}" placeholder="Quantity" value="" required>
        ...
        $(document).on('change', '.batch_number', function (e) {
            ...
            $.get("{{ url('fgs/cdc/fetchBatchCardQtyManufatureDate') }}?batch_id="+batch_id ,function(data){
                ...
                $(".product").select2({
                    ...
                    let res = $(this).select2('data')[0];
                        if(typeof(res) != "undefined" ){
                            ...
                            $.get("{{ url('fgs/cdc/fetchProductBatchCards') }}?product_id="+res.id,function(data)
                            {
