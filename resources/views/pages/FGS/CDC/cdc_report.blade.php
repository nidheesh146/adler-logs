  ...
  <div class="container">
	<div class="az-content-body">
		<div class="az-content-breadcrumb"> 
			 <span><a href="" style="color: #596881;">DC-CDC Report</a></span>
             <span><a href="">CDC Report</a></span>
        </div>
        @include('includes.fgs.dc-cdc-tab')
        <br/><br/>
                                        ...
                                        <div class="row filter_search" style="margin-left: 0px;">
                                            <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10 row">
                                                <div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                                    <label  style="font-size: 12px;">CDC Number</label>
                                                    <input type="text" value="{{request()->get('cdc_no')}}" id="cdc_no" class="form-control" name="cdc_no" placeholder="CDC No">
                                                </div> 
                                                <div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                                    <label  style="font-size: 12px;">DC Number</label>
                                                    <input type="text" value="{{request()->get('dc_no')}}" id="dc_no" class="form-control" name="dc_no" placeholder="DC No">
                                                </div> 
...
<script>
  $(function(){
    ...
    $('.search-btn').on( "click", function(e)  {
        ...
        if(!sku_code & !batch_no & !cdc_no & !dc_no & !customer)
        {
            e.preventDefault();
        }
    });
