	...
	<div class="container">
		<div class="az-content-body">
			<div class="az-content-breadcrumb"> 
				 <span>CANCELLATION MATERIAL ISSUE NOTE(MTQ)</span>
				 <span><a href="">
				 	CMTQ  Transaction List
				</a></span>
				 </div>
            ...
            CMTQ  Transaction List
			  ...
			  <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('fgs/fgs-cmtq-export').'?'.http_build_query(array_merge(request()->all()))}}'" class="badge badge-pill badge-info"><i class="fas fa-file-excel"></i> Report</button>
											...
											<div class="row filter_search" style="margin-left: 0px;">
												<div class="col-sm-10 col-md- col-lg-10 col-xl-10 row">
                                                    ...
                                                    <div class="form-group col-sm-12 col-md-3 col-lg- col-xl-4">
														<label>CMTQ No :</label>
														<input type="text" value="{{request()->get('cmin_no')}}" name="cmtq_no" id="cmtq_no" class="form-control" placeholder="CMTQ NO">
													</div><!-- form-group -->
													
													<div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
														<label  style="font-size: 12px;">CMTQ Month</label>
