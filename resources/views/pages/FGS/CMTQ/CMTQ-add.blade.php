...
<div class="az-content az-content-dashboard">
    ...
    <div class="container">
        <div class="az-content-body">
            ...
            <div class="az-content-breadcrumb">
                <span><a href="" style="color: #596881;">Cancellation Material Transferred To Qurantine(CMTQ)</a></span>
                    ...
                    <form method="POST" id="commentForm" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4" data-select2-id="7">
                                <label>MTQ Number *<span class="spinner-border spinner-button spinner-border-sm" style="display:none;" role="status" aria-hidden="true"></span></label>
                                @if(!empty($edit['mtq']))
                                <input type="hidden" name="mtq_number" value="{{$edit['mtq']->mtq_number}}">

                                @endif
                                <select class="form-control mtq_number" name="mtq_number" @if(!empty($edit['mtq'])) disabled @endif>
                                    <!-- <option value="" ></option> -->
                                    @if(!empty($edit['mtq']))
                                    <option value="{{$edit['mtq']->mtq_number}}" selected>{{$edit['mtq']->mtq_number}}</option>
                                    @endif
                                </select>
                            </div>

                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <label>CMTQ date *</label>
                                <input type="text" class="form-control datepicker" value="{{ date("d-m-Y") }}" name="cmtq_date" placeholder="Cmtq Date" id="cmtq_date">
                                @if(!empty($edit['mtq']))
    ...
    <script>
        ...
        $(".mtq_number").select2({
            ...
            allowClear: true,
            ajax: {
                url: "{{ url('fgs/CMTQ/find-mtq-number-for-cmtq') }}",
            ...
            if (res) {
                $.get("{{ url('fgs/CMTQ/find-mtq-info') }}?id=" + res.id, function(data) {
