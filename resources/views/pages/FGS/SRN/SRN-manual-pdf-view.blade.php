    ...
    <td>: 
        ...
        <div class="col22">
            <table style="float:left;">
                <tr>
                    <td>DNI/EXI No.</td>
                    <td>: {{$srn['dni_number_manual']}}</td>
                </tr>
                <tr>
                    <td> DNI/EXI  Date</td>
                    <td>: @if($srn['dni_date_manual']) {{date('d-m-Y', strtotime($srn['dni_date_manual']))}} @endif</td>
                </tr>
...
?>
                <span class="value_in_words"><?php echo( $fn->getIndianCurrencyInt(round(number_format((float)($grand), 2, '.', '')))) ?> {{--$srn['currency_code']--}} Only</span>
                <div></div><br/><br/>
                {{--<div class="col51" style="width:65%;margin-top:20px;">
        ...
        <div class="col42">
            <div class="" style="height:50px;margin-left:-340px;margin-top:190px;">
            <strong>Remarks: </strong><br/>
                <div><?= nl2br($srn['remarks']); ?></div><br/>
            </div>
            {{--<div class="col52" style="margin-top:20px;">
    ...
    <!-- Other Charges -->
    <tr>
        <td style="text-align:left; padding-right:10px;">Other Charges</td>
        <td style="text-align:right;">{{ number_format($srn->other_charges) }}</td>
    </tr>
...
<div class="row5" style="float:right;margin-top:150px; margin-right:-140px;font-size:12px;">
            <div>
                <p>For Adler Healthcare Pvt. Ltd.</p>
                <br/>
            </div>
