    ...
    <div class="row" style="margin-left: 10px; margin-right: 10px; ">
                    ...
                    <table id="table1" style="width: 100%;">
                        <tr>
                            ...
                            <td colspan="2" rowspan="2" style="width: 20%; font-size: bold;">Ref. No.: {{$cdc->ref_no}}<br>
                                Ref. Date: {{date('d-m-Y',strtotime($cdc->ref_date))}}
                            </td>
                        ...
                        Doc Date :{{date('d-m-Y',strtotime($cdc->doc_date))}}
                            </td>
                        ...
                        <tr>
                            <td colspan="3" style="font-weight: bold;">Stock Location (Increase): <span></span></td>
                            <td colspan="4">{{$cdc->location_name1}}</td>
        ...
        <table id="table2" style="width: 100%;">
            ...
            <tr>
                ...
                <td>@if($item->expiry_date=='0000-00-00' || $item->expiry_date==NULL ) N.A @else {{date('d-m-Y',strtotime($item->expiry_date))}} @endif</td>
                @else
                <td>{{date('d-m-Y',strtotime($item->mrn_manf))}}</td>
                <td>@if($item->mrn_exp=='0000-00-00' || $item->mrn_exp==NULL ) N.A @else {{date('d-m-Y',strtotime($item->mrn_exp))}} @endif</td>
                @endif            </tr>
            @endforeach
            <tr>
                <th></th>
