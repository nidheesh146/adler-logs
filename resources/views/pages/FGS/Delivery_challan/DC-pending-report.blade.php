...
<div class="az-content az-content-dashboard">
		...
		<div class="az-content-body">
			...
			<h4 class="az-content-title" style="font-size: 20px;">
				...
				<div class="right-button">
					<button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('fgs/pending-DC-export').'?'.http_build_query(array_merge(request()->all()))}}'" class="badge badge-pill badge-info"><i class="fas fa-file-excel"></i> Report</button>
				</div>
			</h4>
											...
											<div class="row filter_search" style="margin-left: 0px;">
												<div class="col-sm-10 col-md- col-lg-10 col-xl-10 row">
													...
													<div class="form-group col-sm-12 col-md-3 col-lg- col-xl-4">
														<label>DC No :</label>
														<input type="text" value="{{request()->get('oef_number')}}" name="dc_number" id="dc_number" class="form-control" placeholder="DC NO">
													</div><!-- form-group -->
													...
													<div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
														<label style="font-size: 12px;">DC Month</label>
    ...
    <input type="text" value="{{ request()->get('customer') }}" name="customer" id="customer" class="form-control" placeholder="Customer Name">
</div>
