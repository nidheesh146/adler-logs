                ...
                <div class="col-lg-12 col-xl-12 mg-t-20 mg-lg-t-0">
                    ...
                    <h4 class="az-content-title" style="font-size: 20px;">
                        ...
                        <div class="right-button">
                            @if($location=='All')
                            <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('fgs/Delivery_challan/Challan-stock-all-export')}}'" class="badge badge-pill badge-info "><i class="fas fa-file-excel"></i> Report</button>
                        @elseif($location=='consignment')
                        <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('fgs/Delivery_challan/Challan-stock-export/consignment')}}'" class="badge badge-pill badge-info "><i class="fas fa-file-excel"></i> Report</button>
                        @elseif($location=='loaner')
                        <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('fgs/Delivery_challan/Challan-stock-export/loaner')}}'" class="badge badge-pill badge-info "><i class="fas fa-file-excel"></i> Report</button>
                        @elseif($location=='replacement')
                        <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('fgs/Delivery_challan/Challan-stock-export/replacement')}}'" class="badge badge-pill badge-info "><i class="fas fa-file-excel"></i> Report</button>
                        @elseif($location=='demo')
