...
<body>
    ...
    <div class="row3" style="font-size:12px; ">
        ...
        <span>Kindly arrange to deposit the payment of Rs.{{number_format((float)($total_amount), 2, '.', '')}} 
            ( In Words Rs. <?php echo( $fn->getIndianCurrencyInt(number_format((int)($total_amount), 2, '.', ''))) ?> ) in The Federal Bank Limited (Nearest Branch) within 15 days from the
