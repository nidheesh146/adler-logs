    ...
    <div class="container">
        <div class="az-content-body">
            ...
            <div class="az-content-breadcrumb">
                ...
                Stock Adjustment - Decrease(SAD)</a></span>
                <span><a href="" style="color: #596881;">
                        SAD Item</a></span>
            </div>
                        ...
                        <div class="row">
                            ...
                            <table class="table table-bordered">
                                <tbody id="dynamic_field">
                                    <input type="hidden" value="{{$sad_id}}" name="sai_id" id="sad_id">
                                    <input type="hidden" value="{{$loc}}" name="loc" id="loc">
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2" style="float:left;">
                                                    ...
                                                    <input type="text" readonly class="form-control" name="Itemtype" id="hsn_code1" placeholder="HSN Code">
                                                ...
                                                <div class="form-group col-sm-12 col-md-3 col-lg-3 col-xl-3" style="float:left;">
                                                    ...
                                                    <select class="form-control batch_number batch_no1" index="1" name="moreItems[0][batch_no]">
                                                    </select>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2" style="float:left;">
                                                    ...
                                                    <input type="text" class="form-control" name="moreItems[0][quantity]" id="quantity1" placeholder="Quantity" value="1">
                                                </div>
                                                ...
                                                <div class="form-group col-sm-12 col-md-3 col-lg-3 col-xl-3" style="float:left;">
                                                    ...
                                                    <input type="text" class="form-control datepicker expiry_date" name="moreItems[0][expiry_date]" value="" id="expiry_date1" placeholder="Date of Expiry">
                                                </div>
...
<script>
            ...
            $('#dynamic_field').append(`
                      ...
                      <td>
                        ...
                        <div class="row"> 
                            ...
                            <div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2" style="float:left;">
                                <label>Rate* </label>
                                <input type="text"  class="form-control" name="moreItems[${i}][rate]" id="rate${i}" placeholder="Rate">
                            </div>
                            <div class="form-group col-sm-12 col-md-3 col-lg-3 col-xl-3" style="float:left;">
                                <label>Date of Mfg. * </label>
    ...
    $(document).on('change', '.batch_number', function (e) {
           ...
           // alert(sai);
            $.get("{{url('fgs/saifetchBatchCardQtyManufatureDate') }}?batch_id="+batch_id+"&loc="+loc ,function(data){
               
                $("#stock_qty"+select_id+"").val(data['quantity']);
                $("#qty"+select_id+"").val(data['quantity']);
                $("#datastock_qty"+select_id+"").attr('max',data['quantity']);
    ...
    function initSelect2() {
        ...
        $(".product").select2({
            ...
            if (typeof(res) != "undefined") {
                ...
                $.get("{{ url('fgs/saifetchProductBatchCards') }}?product_id=" + res.id, function(data) {
