...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/css/bootstrap.min.css">
    ...
    <title>CMIN_{{$cmin['firm_name']}}_{{$cmin['cmin_number']}}</title
</head>
<body>
@inject('fn', 'App\Http\Controllers\Web\PurchaseDetails\PurchaseController')
    ...
    <div style="display:block;height: 8px;width:90%; border-bottom: solid black;margin-bottom:40px;margin-top:-50px;">
        <span style="float:right;font-weight:bold;font-size: 22px; background-color: #f4f5f8; padding: 0 4px;margin-top:-12px;position: absolute;margin-right:-80px"> Cancellation
        Material Issue Note (CMIN)<!--Padding is optional-->
        </span>
    </div>
