	...
	<div class="container">
		<div class="az-content-body">
            ...
            CGRS  Transaction List
			  ...
			  <button style="float: right;font-size: 14px; font-weight: bold;" onclick="document.location.href='{{url('fgs/fgs-cgrs-export').'?'.http_build_query(array_merge(request()->all()))}}'" class="badge badge-pill badge-info"><i class="fas fa-file-excel"></i> Report</button>
											...
											<div class="row filter_search" style="margin-left: 0px;">
												<div class="col-sm-10 col-md- col-lg-10 col-xl-10 row">
                                                    ...
                                                    <div class="form-group col-sm-12 col-md-3 col-lg- col-xl-4">
														<label>CGRS No :</label>
														<input type="text" value="{{request()->get('cgrs')}}" name="cgrs_no" id="cgrs_no" class="form-control" placeholder="CGRS NO">
													</div><!-- form-group -->
													
													<div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
														<label  style="font-size: 12px;">CGRS Month</label>
					...
					<div class="table-responsive">
						<table class="table table-bordered mg-b-0" >
                            ...
                            <td>{{$sl++}}</td>
                                ...
                                <td>{{$item->cgrs_number}}</td>
                                <td>{{$item->quantity}} Nos</td>
                                <td>{{date('d-m-Y',strtotime($item->cgrs_date))}}</td>
                            </tr>
                            @endforeach
							</tbody>
						</table>
