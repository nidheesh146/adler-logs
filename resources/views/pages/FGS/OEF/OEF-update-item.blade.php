            ...
            <div class="az-content-body">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="border: 0px solid rgba(28, 39, 60, 0.12);">
                        ...
                        <form method="post" id="commentForm" novalidate="novalidate" action="{{url('fgs/OEF-item-update')}}">
                            {{ csrf_field() }}
                            <div class="row">
                                        ...
                                        <tr id="row1" rel="1">
                                            <td>
                                                ...
                                                <div class="form-group col-sm-12 col-md-3 col-lg-3 col-xl-3"
                                                    ...
                                                    <input type="text" readonly class="form-control" name="product_code"
                                                        id="product_code" value="{{$items->sku_code}}">
                                                        <input type="hidden" readonly class="form-control" name="product_id"
                                                ...
                                                <div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2"
                                                    ...
                                                    <input type="text" readonly class="form-control" name="hsn_code1"
                                                        id="hsn_code1" value="{{$items->hsn_code}}">
                                                    {{--<input type="hidden"
                                                ...
                                                <div class="form-group col-sm-12 col-md-3 col-lg-3 col-xl-3"
                                                    ...
                                                    value="">{{$items->discription}}</textarea>
                                                </div>
                                                <div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2"
                                                    style="float:left;">
                                                    <label>Quantity * </label>
                                                    <input type="text"  class="form-control" name="quantity1"
                                                        id="quantity1" placeholder="Quantity" value="{{$items->quantity}}">
                                                </div>
                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2" style="float:left;">
                                                    ...
                                                    <input type="text" class="form-control" name="igst" id="igst1" value="{{$items->igst}}" readonly>
                                                </div>
                                                <div class="form-group col-sm-12 col-sm-12 col-md-2 col-lg-2 col-xl-2" style="float:left;">
                                                    <label> SGST ( % ) </label>
                                                    <input type="text" class="form-control" name="sgst" id="sgst1" value="{{$items->cgst}}" readonly>
                                                </div>
                                                <div class="form-group col-sm-12 col-sm-12 col-md-2 col-lg-2 col-xl-2" style="float:left;">
                                                    <label> CGST ( % ) </label>
                                                    <input type="text" class="form-control" name="cgst" id="cgst1" value="{{$items->sgst}}" readonly>
                                                    <input type="hidden" class="form-control" name="item_id" id="item_id" value="{{$items->id}}" readonly>
