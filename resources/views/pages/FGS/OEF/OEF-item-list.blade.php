							...
							<tbody id="prbody1">
								...
								<tr>
									...
									<td>
										...
										@endif
										<a class="badge badge-danger" style="font-size: 13px;" href="{{url('fgs/OEF-item-delete/'.$item['id'])}}" onclick="return confirm('Are you sure you want to delete this ?');"><i class="fa fa-trash"></i> Delete</a>
