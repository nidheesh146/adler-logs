							...
							<tbody id="prbody1">
								...
								<tr>
									...
									<td> <a class="badge badge-danger" style="font-size: 13px;" onclick="return confirm('Cant Delete.OEF have items!');"><i class="fa fa-trash"></i> Delete</a>
										<a class="badge badge-info" style="font-size: 13px;" href="{{url('fgs/OEF-edit/'.$item['id'])}}" class="dropdown-item"><i class="fas fa-edit"></i> Edit</a>

									</td>
									@else
									<td> <a class="badge badge-danger" style="font-size: 13px;" href="{{url('fgs/OEF-delete/'.$item['id'])}}" onclick="return confirm('Are you sure you want to delete this ?');"><i class="fa fa-trash"></i> Delete</a>
										<a class="badge badge-info" style="font-size: 13px;" href="{{url('fgs/OEF-edit/'.$item['id'])}}" class="dropdown-item"><i class="fas fa-edit"></i> Edit</a>
									</td>
									@endif
								</tr>
