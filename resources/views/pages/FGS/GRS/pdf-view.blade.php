...
@inject('fn', 'App\Http\Controllers\Web\PurchaseDetails\PurchaseController')
    ...
    <div style="display:block;height: 8px;width:90%; border-bottom: solid black;margin-bottom:40px;">
        ...
        Goods Reservation Slip(GRS)<!--Padding is optional-->
        </span>
    </div>
    <br/>
    <div class="row2">
        <div class="col21">
            <table>
                ...
                <tr>
                    <td>OEF Date</td>
                    <td>: {{date('d-m-Y', strtotime($grs['oef_date']))}}</td>
                </tr>
                <tr>
                    <td>Order No.</td>
                    <td>: {{$grs['order_number']}} </td>
                </tr>
                <tr>
                    <td>Order Date</td>
        ...
        <div class="col22">
            <table style="float:left;">
                ...
                <tr>
                    <td>Order Fulfil</td>
                    <td>: {{$grs['order_fulfil_type']}} </td>
                </tr>
                <tr>
                    <td> Sales Type</td>
                    <td>: {{$grs['sales_type']}}</td>
                </tr>
                <tr>
                    <td>Trnsctn Type</td>
