	...
	<div class="container">
		<div class="az-content-body">
            <div class="az-content-breadcrumb"> 
                <span><a href="{{url('product/list')}}" style="color: #596881;">PRICE </a></span> 
                <span><a href="{{url('product/file/upload')}}" style="color: #596881;">PRICE MASTER UPLOAD</a></span>
            </div>

            <h4 class="az-content-title" style="font-size: 20px;margin-bottom: 18px !important;">Price Upload
            </h4>
			...
			<div class="row">     
                <div class="col-sm-12   col-md-12 col-lg-12 col-xl-12 " style="border: 0px solid rgba(28, 39, 60, 0.12);">
                    ...
                    <form method="POST"  action="{{url('fgs/price-master/upload')}}" id="commentForm" enctype='multipart/form-data'>
               
                        {{ csrf_field() }}  
                        <div class="row ">
                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <label for="exampleInputEmail1">Select File </label>
                                <label style=" font-size: 10px; color: red;">Please empty the column if the data is not updating </label>
                                ...
                                <a href="{{ asset('uploads/SNN_Product_DP (25).xlsx') }}"  target="_blank" style="
                                float: right;
                                font-size: 10px;
                            "> Download Template</a>
                            </div> 
