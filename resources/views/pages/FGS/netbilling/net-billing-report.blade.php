	...
	<div class="container">
		<div class="az-content-body">
			...
			<h4 class="az-content-title" style="font-size: 20px;">Net billing Report
				<button style="float: right; font-size: 14px;" onclick="document.location.href='{{url('fgs/net-bk-billing-report/export').'?'.http_build_query(array_merge(request()->all()))}}'" class="badge badge-pill badge-info">
