		...
		<div class="az-content-body">
			...
			<h4 class="az-content-title" style="font-size: 20px;">
              ...
              <div class="right-button">
                <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('fgs/CPI/CPI-add')}}'" class="badge badge-pill badge-dark "><i class="fas fa-plus"></i> 
						CPI
				</button>
              <div>  
			...
			<div class="tab-content"> 
				<div class="row row-sm mg-b-20 mg-lg-b-0">
										...
										<th scope="row">
											<div class="row filter_search" style="margin-left: 0px;">
												...
												<div class="form-group col-sm-12 col-md-3 col-lg- col-xl-4">
														<label>CPI No :</label>
														<input type="text" value="{{request()->get('cpi_number')}}" name="cpi_number" id="cpi_number" class="form-control" placeholder="CPI NO">
													</div><!-- form-group -->
					...
					<div class="table-responsive">
                        ...
                        {{ $cpi->appends(request()->input())->links() }}
						</div>
					</div>
				</div>
			</div>
