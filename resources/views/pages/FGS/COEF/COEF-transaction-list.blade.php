	...
	<div class="container">
		<div class="az-content-body">
            ...
            COEF  Transaction List
			  ...
			  <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('fgs/fgs-coef-export').'?'.http_build_query(array_merge(request()->all()))}}'" class="badge badge-pill badge-info"><i class="fas fa-file-excel"></i> Report</button>
											...
											<div class="row filter_search" style="margin-left: 0px;">
												<div class="col-sm-10 col-md- col-lg-10 col-xl-10 row">
                                                    ...
                                                    <div class="form-group col-sm-12 col-md-3 col-lg- col-xl-4">
														<label>COEF No :</label>
														<input type="text" value="{{request()->get('coef_no')}}" name="coef_no" id="coef_no" class="form-control" placeholder="COEF NO">
													</div><!-- form-group -->
...
<script>
  $(function(){
	...
	$('.search-btn').on( "click", function(e)  {
		...
		var coef_no = $('#coef_no').val();
        var item_code = $('#item_code').val();
		var from = $('#from').val();
		if(!coef_no  & !item_code & !from)
		{
			e.preventDefault();
		}
	});
