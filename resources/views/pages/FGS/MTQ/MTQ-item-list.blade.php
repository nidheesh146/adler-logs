  ...
  <br>
	<div class="container">
		<div class="az-content-body">
            ...
            MTQ Item List @if($mtq_number)({{$mtq_number}}) @endif
              <div class="right-button">
                <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('fgs/MTQ/add-item/'.$mtq_id)}}'" class="badge badge-pill badge-dark "><i class="fas fa-plus"></i> 
						MTQ Item
				</button>
              <div>  
