	...
	<div class="container">
		<div class="az-content-body">
			<div class="az-content-breadcrumb"> 
				 <span>MATERIAL ISSUE NOTE(MTQ)</span>
				 <span><a href="">
            ...
            MTQ  Transaction List
			  ...
			  <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('fgs/fgs-mtq-export').'?'.http_build_query(array_merge(request()->all()))}}'" class="badge badge-pill badge-info"><i class="fas fa-file-excel"></i> Report</button>
											...
											<div class="row filter_search" style="margin-left: 0px;">
												<div class="col-sm-10 col-md- col-lg-10 col-xl-10 row">
                                                    ...
                                                    <div class="form-group col-sm-12 col-md-3 col-lg- col-xl-4">
														<label>MTQ No :</label>
														<input type="text" value="{{request()->get('cmin_no')}}" name="mtq_no" id="mtq_no" class="form-control" placeholder="CMIN NO">
													</div><!-- form-group -->
