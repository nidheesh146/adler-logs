  ...
  <br>
	<div class="container">
		<div class="az-content-body">
			...
			<h4 class="az-content-title" style="font-size: 20px;">@if(request()->get('order_type')=='wo') Work @else Purchase @endif Order - Excess Order Quantity
                            ...
                            <tbody>
                                ...
                                <tr style="	@if($po_data->status == 5)
								    ...
								    <div class="dropdown-menu">
                                        <a href="{{url('inventory/final-purchase-view/'.$po_data->id.'/excess-quantity')}}" class="dropdown-item" style="padding:2px 15px;"><i class="fas fa-eye"></i> View</a>
                                    ...
                                    @if($po_data->status==1)
                                        <a href="{{url('inventory/final-purchase-view/'.$po_data->id.'/excess-quantity')}}"   po="{{$po_data->po_number}}" status="{{$po_data->status}}" rq="{{$po_data->rq_no}}" podate="{{date('d-m-Y',strtotime($po_data->po_date))}}" supplier ="{{$po_data->vendor_name}}" value="{{$po_data->po_id}}" data-target="#excessOrderModal" 
