        ...
        <div class="col21">
            <table>
                <tr>@if($type=='cancel')
                    ...
                    <td>:  
                                  @php 
                                     $rq_master_id = explode(',', $final_purchase->rq_master_id);
                                    @endphp

                                    @foreach($rq_master_id as $id)
                                       @php 
                                         $values = app()->make('App\Http\Controllers\Web\PurchaseDetails\PurchaseController')->getRQNumber($id); 
                                       @endphp
                ...
                <tr>
                    ...
                    <td>: {{date('d-m-Y',strtotime($final_purchase['rq_date']))}}</td>
                    @endif
                </tr>
                <tr>
                    <td >Currency</td>
