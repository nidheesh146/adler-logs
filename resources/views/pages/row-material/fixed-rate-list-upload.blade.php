	...
	<div class="container">
		<div class="az-content-body">
            <div class="az-content-breadcrumb"> 
                ...
                <span><a href="{{url('row-material/fixed-rate/upload')}}" style="color: #596881;">Fixed Rate Material Upload</a></span>
            </div>

            <h4 class="az-content-title" style="font-size: 20px;margin-bottom: 18px !important;">Fixed Rate Material Upload
            </h4>
			...
			<div class="row">     
                <div class="col-sm-12   col-md-12 col-lg-12 col-xl-12 " style="border: 0px solid rgba(28, 39, 60, 0.12);">
                    ...
                    <form method="POST"  action="{{url('row-material/fixed-item-upload')}}" id="commentForm" enctype='multipart/form-data'>
                        ...
                        <div class="row ">
                            <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                ...
                                <a href="{{ asset('uploads/fixed_item_sample.xlsx') }}"  target="_blank" style="
                                float: right;
                                font-size: 10px;
                            "> Download Template</a>
                            </div> 
