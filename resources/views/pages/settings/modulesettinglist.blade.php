    ...
    <div class="container">
        <div class="az-content-body">
            <div class="az-content-breadcrumb">
                <span><a href="" style="color: #596881;">Config setting</a></span>
            </div>
                                        ...
                                        <div class="row filter_search" style="margin-left: 0px;">
                                            <div class="col-sm-10 col-md- col-lg-10 col-xl-12 row">
                                                <div class="form-group col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                    ...
                                                    <input type="text" value="{{request()->get('name')}}" name="name" id="name" class="form-control" placeholder="SName">
                                                </div><!-- form-group -->
                ...
                <table class="table table-bordered mg-b-0" id="example1">
                    <thead>
                        <tr>
                            ...
                            <th>Rev Date</th>
                            <th>Rev No</th>
                            <th>Quotation head 1</th>
                            <th>Email</th>
                            <th>Quotation head 2</th>
                            <th>Email</th>
                            <th>Quotation head 3</th>
                            <th>Email</th>
                            <th>Purchase head 1</th>
                            <th>Email</th>
                            <th>Purchase head 2</th>
                            <th>Email</th>
                            <th>Purchase head 3</th>
                            <th>Email</th>
                            <th>FGS head 1</th>
                            <th>Email</th>
                            <th>FGS head 2</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$items->name}}</td>
                            <td>{{$items->value}}</td>
                            <td>{{date('d-m-Y',strtotime($items->re_date))}}</td>
                            <td>{{$items->rev_number}}</td>
                            <td>{{$items->qtn_head1}}</td>
                            <td>{{$items->qtn_email_id1}}</td>
                            <td>{{$items->qtn_head2}}</td>
                            <td>{{$items->qtn_email_id2}}</td>
                            <td>{{$items->qtn_head3}}</td>
                            <td>{{$items->qtn_email_id3}}</td>
                            <td>{{$items->purchase_head1}}</td>
                            <td>{{$items->pur_email_id1}}</td>
                            <td>{{$items->purchase_head2}}</td>
                            <td>{{$items->pur_email_id2}}</td>
                            <td>{{$items->purchase_head3}}</td>
                            <td>{{$items->pur_email_id3}}</td>
                            <td>{{$items->fgs_head1}}</td>
                            <td>{{$items->fgs_email_id1 }}</td>
                            <td>{{$items->fgs_head2}}</td>
                            <td>{{$items->fgs_email_id2}}</td>
                            <td>{{$items->fgs_head3}}</td>
                            <td>{{$items->fgs_email_id3}}</td>
                            <td>
                                <a class="badge badge-info" style="font-size: 13px;" href="{{url('settings/config/'.$items->id)}}" class="dropdown-item"><i class="fas fa-edit"></i> Edit</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <table>
                                        <tr>
                                            <td>Item Code : </td>
                                            <td><input type="text" class="item form-control" disabled></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                Quantity :&nbsp;
