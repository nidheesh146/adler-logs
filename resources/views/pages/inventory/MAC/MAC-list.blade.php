	...
	<div class="az-content-body">
		...
		<h4 class="az-content-title" style="font-size: 20px;">@if(request()->get('order_type')=='wo') Work Order Acceptance(WOA) @else Material Acceptance(MAC) @endif
			  ...
			  <a href="#" class="dropdown-item">Excel</a>
                ...
                @endif
                <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('inventory/MAC/excel-export').'?'.http_build_query(array_merge(request()->all()))}}'" class="badge badge-pill badge-info"><i class="fas fa-file-excel"></i> Report</button>
	  		</div>
		</h4>
