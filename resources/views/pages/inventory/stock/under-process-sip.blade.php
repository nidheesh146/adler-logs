  ...
  <div class="container">
	<div class="az-content-body">
		<div class="az-content-breadcrumb"> 
			 <span><a href="">Stock Issue To Production - Under Development</a></span>
		</div>
		<h4 class="az-content-title" style="font-size: 20px;">Stock Issue To Production - Under Development
        ...
        <div class="card-header bg-gray-400 bd-b-0-f pd-b-0">
            ...
            <a class="nav-link " href="{{url('inventory/Stock/ToProduction/Direct')}}">SIP -Direct</a>
                ...
                <a class="nav-link active"  href="{{url('inventory/Stock/ToProduction/underProcess')}}">SIP -Under Development</a>
            </nav> 
        </div><br/>
		<form method="post" action="">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-12col-md-4 col-lg-4 col-xl-4">
                    ...
                    <input type="radio"  checked class="form-control" name="under_process" id="under_process" style="margin-left: 21px;width:28px;">
                </div>
                <br/>
            </div>
            ...
            <div class="form-devider"></div>
            <div class="batchdiv" style="">
                <div class ="batchcards">
                    <div style='color:#3366ff;font: size 15px;'><i class='typcn typcn-tabs-outline' style='font-size:21px;'></i>&nbsp;<strong>BatchCards</strong></div>
                        <div class='row'>
                                ...
                                <table class='table table-bordered mg-b-0' id='example'>
                                    ...
                                    <tbody>
                                        @foreach($batchcards as $card)
                                            <tr>
                                                <th>
                                                    <input type='checkbox' class='batchcard-checkbox' onclick='enableTextBox(this)'  name='batchcard[]' value='{{$card->batchcard_id}}' batchqty='{{$card->material_qty}}'>
                                                    <input type='hidden' name='batchcard_material_id' value="{{$card->batchcard_material_id}}">
                                                    <input type='hidden' name='rawmaterial_id' value="{{$card->rawmaterial_id}}">

                                                </th>
                                                <th>{{$card->batch_no}}</th>
                                                <th>{{$card->sku_code}}</th>
                                                <th>{{$card->sku_quantity}} Nos</th>
                                                <th class='qty'>
                                                    <span>{{$card->item_code}}</span>
                                                </th>
                                            </tr>
                                        @endforeach
                                    <tbody>
