        ...
        <div class="container" data-select2-id="9">
            <div class="az-content-body" data-select2-id="8">
                <div class="az-content-breadcrumb">
                    <span><a href="{{ url('inventory/supplier-invoice') }}">Stock Issue To Production</a></span>
                    <span>@if(!empty($edit)) Edit @else Add @endif Stock Issue To Production Info</span>
                </div>
                <h4 class="az-content-title" style="font-size: 20px;">@if(!empty($edit)) Edit @else Add @endif Stock Issue To Production Info @if(!empty($edit)) (SIP3-2223-001) @endif
                </h4>
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody >
                            <tr>
                                    ...
                                    <th>Expiry Date</th>
                                    <th>Remarks</th>
                                <th><a class="badge badge-info" style="font-size: 13px;" href="{{url('inventory/Stock/ToProduction/1/item')}}"  class="dropdown-item"><i class="fas fa-edit"></i> Edit</a> 	</th>
                            </tr>
