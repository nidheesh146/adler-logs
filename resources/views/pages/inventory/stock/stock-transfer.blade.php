  ...
  <div class="container">
	<div class="az-content-body">
		<div class="az-content-breadcrumb"> 
			 <span><a href="">Stock From Order</a></span>
		</div>
		<h4 class="az-content-title" style="font-size: 20px;">Stock From Order
			  ...
			  <a href="#" class="dropdown-item">Excel</a>
				...
				<button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('inventory/Stock/transfer-add')}}'" class="badge badge-pill badge-dark "><i class="fas fa-plus"></i> Stock From Order</button> 
	  		</div>
		</h4>
		...
		<div class="table-responsive">
			<table class="table table-bordered mg-b-0" id="example1">
				...
				<tbody>
                    ...
                    <tr>
                       <td>SIP3-2223-0001</td>
                       <td>	Production</td>
                       <td>Nayan</td>
                       <td>12-11-2022</td>
                        <td><a class="badge badge-info" style="font-size: 13px;" href="{{url('inventory/Stock/ToProduction-add/1')}}"  class="dropdown-item"><i class="fas fa-edit"></i> Edit</a> 	</td>
                    </tr>
