    ...
    <div class="container">
        <div class="az-content-body">
            <div class="az-content-breadcrumb">
                <span><a href="">FGS Transfer</a></span>
            </div>
            <h4 class="az-content-title" style="font-size: 20px;">Add FGS Transfer 
                <div class="right-button">
                <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('inventory/fgs-transfer')}}'" class="badge badge-pill badge-dark "><i class="fas fa-plus"></i>FGS transfer Add </button> 
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12" style="margin: 0px;">
                            <label style="color: #3f51b5;font-weight: 500;margin-bottom:2px;">
                                <i class="fas fa-address-card"></i> FGS Transfer list
                            </label>
