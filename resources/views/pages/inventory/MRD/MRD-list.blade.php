  ...
  <div class="container">
	<div class="az-content-body">
		<div class="az-content-breadcrumb"> 
			 <span><a href="">Material Rejection & Delivery(MRD)</a></span>
		</div>
		<h4 class="az-content-title" style="font-size: 20px;">Material Rejection & Delivery(MRD)
			...
			<table class="table table-bordered mg-b-0" id="example1">
				...
				<tbody>
                    ...
                    <tr>
                       ...
                       <td>100</td>
                       <td>Reason</td>
                        <td><a class="badge badge-info" style="font-size: 13px;" href="{{url('inventory/MRD-add/1')}}"  class="dropdown-item"><i class="fas fa-edit"></i> Edit</a> 	</td>
                    </tr>
