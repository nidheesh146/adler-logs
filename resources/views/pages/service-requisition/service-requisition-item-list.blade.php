	...
	<div class="container">
		<div class="az-content-body">
            ...
            <div class="az-content-breadcrumb"> 
                <span><a href="{{url('inventory/get-purchase-reqisition')}}" style="color: #596881;">SERVICE DETAILS</a></span> 
                <span><a href="{{url('inventory/get-purchase-reqisition')}}" style="color: #596881;">SERVICE REQUISITION</a></span>
                <span><a href="">List Service requisition item ( {{$data["master"]['pr_no']}}  )</a></span>
            </div>
	
            <h4 class="az-content-title" style="font-size: 20px;">List Service requisition item ( {{$data["master"]['pr_no']}}  )
              ...
              <button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('inventory/add-service-reqisition-item?sr_id='.request()->sr_id)}}'" class="badge badge-pill badge-dark "><i class="fas fa-plus"></i> Service requisition item</button>
            </div>
          </h4>
            ...
            <div class="az-dashboard-nav">
                <nav class="nav">
                    <a class="nav-link" href="{{url('inventory/edit-purchase-reqisition?pr_id='.request()->pr_id)}}">Service requisition master </a>
