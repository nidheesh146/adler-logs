	...
	<div class="container">
		<div class="az-content-body">
			<div class="az-content-breadcrumb"> 
				 <span>Service Requisition details</span>
				 <span><a href="">Service Requisition</a></span>
				 </div>
			<h4 class="az-content-title" style="font-size: 20px;">Service Requisition 
			...
			<button style="float: right;font-size: 14px;" onclick="document.location.href='{{url('inventory/add-purchase-reqisition')}}'" class="badge badge-pill badge-dark "><i class="fas fa-plus"></i> Service Requisition   </button>
          </div>
        </h4>
                                    ...
                                    <div class="row filter_search" style="margin-left: 0px;">
                                       <div class="col-sm-10 col-md- col-lg-10 col-xl-10 row">
									   		...
									   		<div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                <label>SR No:</label>
                                                <input type="text" value="{{request()->get('sr_no')}}" name="sr_no" id="sr_no" class="form-control" placeholder="SR NO">
                                            </div><!-- form-group -->
