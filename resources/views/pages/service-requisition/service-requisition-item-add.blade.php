        ...
        <div class="container">
            <div class="az-content-body">
                ...
                <div class="az-content-breadcrumb">
                    <span><a href="{{ url('inventory/get-purchase-reqisition') }}" style="color: #596881;">SERVICE
                            DETAILS</a></span>
                    <span><a href="{{ url('inventory/get-purchase-reqisition') }}" style="color: #596881;">SERVICE
                            REQUISITION</a></span>
                    <span><a href="">Add Service requisition item ( {{$data["master"]['pr_no']}}  )</a></span>
                </div>

                <h4 class="az-content-title" style="font-size: 20px;margin-bottom: 18px !important;">
                    Add Service requisition item ( {{$data["master"]['pr_no']}}  )</h4>
                <div class="az-dashboard-nav">
                    <nav class="nav">
                        <a class="nav-link    "
                            href="{{ url('inventory/edit-purchase-reqisition?pr_id=' . request()->pr_id) }}">Service
                            requisition master </a>
                        <a class="nav-link  active" @if (request()->pr_id) href="{{ url('inventory/get-purchase-reqisition-item?pr_id=' . request()->pr_id) }}" @endif> Service requisition item </a>
