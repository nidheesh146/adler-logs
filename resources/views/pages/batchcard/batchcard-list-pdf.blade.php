...
@endphp
            ...
            <tr style="font-size:10px;text-align:center;">
                ...
                <th rowspan="2" style="width:35px;">Shift</th>
                <th rowspan="2"  style="width:35px;">OPN No</th>
                <th rowspan="2" style="width:35px;"> M/C No</th>
                <th rowspan="2" style="width:50px;">Operator No.</th>
                <th rowspan="2" style="width:60px;">Measuring inst. No.</th>
            ...
            <tr style="font-size:10px;text-align:center;">
                <th style="width:60px;">A<br/> Accepted</th>
                <th style="width:60px;">B <br/>Rejected</th>
                <th style="width:60px;">C <br/>Remaining</th>
            </tr>
            @for ($i = $f; $i <= $l; $i++)
